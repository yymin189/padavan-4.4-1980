...
<html>
	<head>
		...
		<script>
			var $j = jQuery.noConflict(); <% login_state_hook(); %>
...
function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-2gwifi', 4);
    show_footer();
    if (!support_5g_radio()) {
...
function showACLList() {
    ...
    if (ACLList.length == 0) {
        ...
        code += '<td><button class="btn btn-danger" type="submit" onclick="return markGroupACL(this, 32, \' Del \');" name="rt_ACLList"><i class="if if-btn-minus"></i></button></td>';
        code += '</tr>';
    }
	...
	<body onload="initial();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="rt_macnum_x_0" value="<% nvram_get_x(" ", "rt_macnum_x
				"); %>" readonly="1" />
										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#DeviceSecurity11a_display1_sectiondesc#>
												</div>
													...
													<tr>
														...
														<td style="border-top: 0 none;">
															<select name="rt_macmode" class="input" onchange="change_mac_enabled();">
																<option value="disabled" <% nvram_match_x( "", "rt_macmode",
																"disabled", "selected"); %>
																	>
																	<#CTL_Disabled#>
																</option>
																<option value="allow" <% nvram_match_x( "", "rt_macmode", "allow",
																"selected"); %>
																	>
																	<#FirewallConfig_MFMethod_item1#>
																</option>
																<option value="deny" <% nvram_match_x( "", "rt_macmode", "deny",
																"selected"); %>
																	>
													...
													<tr>
														<td width="35%">
															...
															<div class="input-append">
																<input type="text" maxlength="12" class="span12" size="12" name="rt_maclist_x_0"
																value="<% nvram_get_x(" ", "rt_maclist_x_0 "); %>" onKeyPress="return is_hwaddr(event);"
																style="float:left; width: 175px" />
																<button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);"
																title="Select the MAC of WiFi clients">
														...
														<td width="60%">
															<input type="text" maxlength="32" class="span12" size="32" name="rt_macdesc_x_0"
															value="<% nvram_get_x(" ", "rt_macdesc_x_0 "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
														<td width="5%">
															<button class="btn" style="max-width: 219px" type="submit" onclick="return markGroupACL(this, 32, ' Add ');"
															name="rt_ACLList2" value="<#CTL_add#>" size="12">
												...
												<table class="table">
													<tr>
														<td id="col_goto5" width="50%" style="margin-top: 10px; border-top: 0 none;">
															...
															onclick="location.href='Advanced_ACL_Content.asp';">
														</td>
														<td style="border-top: 0 none;">
