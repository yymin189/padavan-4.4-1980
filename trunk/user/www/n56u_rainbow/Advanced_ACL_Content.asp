...
function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-5gwifi', 4);
    show_footer();
    change_mac_enabled();
    showACLList();
    showLANIPList();
...
function showACLList() {
    ...
    if (ACLList.length == 0) {
        ...
        code += '<td><button class="btn btn-danger" type="submit" onclick="return markGroupACL(this, 32, \' Del \');" name="ACLList"><i class="if if-btn-minus"></i></button></td>';
        code += '</tr>';
    }
	...
	<body onload="initial();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="wl_macnum_x_0" value="<% nvram_get_x(" ", "wl_macnum_x
				"); %>" readonly="1" />
													...
													<tr>
														...
														<td style="border-top: 0 none;">
															<select name="wl_macmode" class="input" onchange="change_mac_enabled();">
																<option value="disabled" <% nvram_match_x( "", "wl_macmode",
																"disabled", "selected"); %>
																	>
																	<#CTL_Disabled#>
																</option>
																<option value="allow" <% nvram_match_x( "", "wl_macmode", "allow",
																"selected"); %>
																	>
																	<#FirewallConfig_MFMethod_item1#>
																</option>
																<option value="deny" <% nvram_match_x( "", "wl_macmode", "deny",
																"selected"); %>
																	>
													...
													<tr>
														<td width="35%">
															...
															<div class="input-append">
																<input type="text" maxlength="12" class="span12" size="12" name="wl_maclist_x_0"
																value="<% nvram_get_x(" ", "wl_maclist_x_0 "); %>" onKeyPress="return is_hwaddr(event);"
														...
														<td width="60%">
															<input type="text" maxlength="32" class="span12" size="32" name="wl_macdesc_x_0"
															value="<% nvram_get_x(" ", "wl_macdesc_x_0 "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
														<td width="5%">
															<button class="btn" style="max-width: 219px" type="submit" onclick="return markGroupACL(this, 32, ' Add ');"
															name="ACLList2" value="<#CTL_add#>" size="12">
