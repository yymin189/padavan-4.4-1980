...
$j(document).ready(function() {
    ...
    init_itoggle('lan_dns_x', on_change_lan_dns);
		...
		<script>
			var old_lan_addr = "<% nvram_get_x("
","
lan_ipaddr "); %>";
var old_lan_mask = "<% nvram_get_x("
","
lan_netmask "); %>";

function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-lan', 1);
    show_footer();
								...
								<div class="span12">
									<div class="box well grad_colour_dark_blue">
										<h2 class="box_head round_top">
											<#LANHostConfig_display1_sectionname#>
										</h2>
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#LANHostConfig_display2_sectiondesc#>
												</div>
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td>
															<input type="checkbox" id="lan_proto_x_fake" <% nvram_match_x( "",
															"lan_proto_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "lan_proto_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" id="lan_proto_x_1" name="lan_proto_x" value="1" class="input"
																	onClick="on_change_lan_dhcp();" <% nvram_match_x( "", "lan_proto_x",
																	"1", "checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" id="lan_proto_x_0" name="lan_proto_x" value="0" class="input"
																		onClick="on_change_lan_dhcp();" <% nvram_match_x( "", "lan_proto_x",
																		"0", "checked"); %>
																		>
																		<#checkbox_No#>
													...
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,4,1);">
																<#LANHostConfig_IPRouters_itemname#>
															</a>
														</th>
														<td>
															<input type="text" id="lan_ipaddr" name="lan_ipaddr" value="<% nvram_get_x("
															", "lan_ipaddr "); %>" maxlength="15" class="input" size="15" onKeyPress="return is_ipaddr(this,event);"
															/>
															&nbsp;
													...
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,4,2);">
																<#LANHostConfig_SubnetMask_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="15" class="input" size="15" name="lan_netmask"
															value="<% nvram_get_x(" ", "lan_netmask "); %>" onkeypress="return is_ipaddr(this,event);"
															/>
															&nbsp;
															<span style="color:#888;">
																255.255.255.0
													...
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,4,3);">
																<#LANHostConfig_x_Gateway_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="15" class="input" size="15" name="lan_gateway"
															value="<% nvram_get_x(" ", "lan_gateway "); %>" onkeypress="return is_ipaddr(this,event);"
															/>
														</td>
													</tr>
													<tr>
													...
													<tr id="row_lan_dns_x">
														...
														<td>
															<input type="checkbox" id="lan_dns_x_fake" <% nvram_match_x( "",
															"lan_dns_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "lan_dns_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" id="lan_dns_x_1" name="lan_dns_x" value="1" class="input"
																	onClick="on_change_lan_dns();" <% nvram_match_x( "", "lan_dns_x", "1",
																	"checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" id="lan_dns_x_0" name="lan_dns_x" value="0" class="input"
																		onClick="on_change_lan_dns();" <% nvram_match_x( "", "lan_dns_x", "0",
																		"checked"); %>
																		>
																		<#checkbox_No#>
																</div>
													...
													<tr>
														...
														<td>
															<input type="text" name="lan_dns1" value="<% nvram_get_x(" ", "lan_dns1
															"); %>" maxlength="15" class="input" size="15" onkeypress="return is_ipaddr(this,event);"
															/>
														</td>
													</tr>
													<tr>
														...
														<td>
															<input type="text" name="lan_dns2" value="<% nvram_get_x(" ", "lan_dns2
															"); %>" maxlength="15" class="input" size="15" onkeypress="return is_ipaddr(this,event);"
															/>
														</td>
													</tr>
