...
function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-sysconfig', 6);
    show_footer();
									...
									<div class="box well grad_colour_dark_blue">
										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<iframe id="term-iframe" style="width: 100%; height: 600px; border: none; display: none;">
												</iframe>
												<div id="console-alert" class="alert alert-danger" style="margin: 10px;">
													<#Console_warn#>
												</div>
												<table id="console-table" width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<td width="80%" style="border-top: 0 none">
															<input type="text" id="SystemCmd" class="span12" name="SystemCmd" maxlength="127"
															onkeypress="if (checkEnter(event)) startPost();" value="">
														</td>
														<td style="border-top: 0 none">
															<input class="btn btn-primary span12" id="btn_exec" onClick="startPost()"
															type="button" value="<#CTL_refresh#>" name="action">
														</td>
														<td style="border-top: 0 none">
															<button class="btn span12" onClick="clearOut();" type="button" value="<#CTL_refresh#>"
															name="action" style="outline: 0">
																<i class="if if-remove">
																</i>
															</button>
														</td>
													</tr>
													<tr>
														<td colspan="3" style="border-top: 0 none">
															<textarea class="span12" id="console_area" style="font-family: 'Courier New', Courier, mono; font-size:13px;"
															rows="23" wrap="off" readonly="1">
