										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#LANHostConfig_x_DDNSEnable_sectiondesc#>
												</div>
												<div id="wan_ip_hide2" class="alert alert-danger" style="display:none; margin: 10px;">
													<#LANHostConfig_x_DDNSEnable_sectiondesc2#>
												</div>
												<div id="wan_ip_hide3" class="alert alert-danger" style="display:none; margin: 10px;">
													<#LANHostConfig_x_DDNSEnable_sectiondesc3#>
												</div>
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th width="50%">
															<#LANHostConfig_x_DDNSEnable_itemname#>
														</th>
														<td>
															<input type="checkbox" id="ddns_enable_x_fake" <% nvram_match_x( "",
															"ddns_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "ddns_enable_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ddns_enable_x" id="ddns_enable_x_1"
																	onClick="change_ddns_enabled();" <% nvram_match_x( "", "ddns_enable_x",
																	"1", "checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ddns_enable_x" id="ddns_enable_x_0"
																		onClick="change_ddns_enabled();" <% nvram_match_x( "", "ddns_enable_x",
																		"0", "checked"); %>
																		>
																		<#checkbox_No#>
													...
													<tr id="row_ddns_server">
														<th>
															<#LANHostConfig_x_DDNSServer_itemname#>
														</th>
														<td>
															<select name="ddns_server_x" class="input" onchange="change_ddns_server(1)">
															</select>
															&nbsp;
															<a id="ddns_link" href="javascript:openLink('x_DDNSServer')" class="label label-info"
															name="x_DDNS_link">
													...
													<tr id="row_ddns_cst_svr" style="display:none;">
														...
														<td>
															<input type="text" class="input" maxlength="64" size="48" name="ddns_cst_svr"
															value="<% nvram_get_x(" ","ddns_cst_svr "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
													</tr>
													<tr id="row_ddns_cst_url" style="display:none;">
														...
														<td>
															<input type="text" class="input" maxlength="64" size="48" style="width: 286px;"
															name="ddns_cst_url" value="<% nvram_get_x(" ","ddns_cst_url "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
													</tr>
													<tr id="row_ddns_hname1">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,3);">
																<#LANHostConfig_x_DDNSHostNames_itemname#>
															</a>
														</th>
														<td>
															<div id="ddnsname_input" style="display:none;">
																<input type="text" class="input" maxlength="64" size="48" style="width: 286px;"
																id="ddns_hostname_x" name="ddns_hostname_x" value="<% nvram_get_x(" ","ddns_hostname_x
																"); %>" onKeyPress="return is_string(this,event);" />
															</div>
															<div id="asusddnsname_input" style="display:none;">
																<input type="text" name="DDNSName" id="DDNSName" style="width: 110px;"
																placeholder="<#asusddns_inputhint#>">
																.asuscomm.com&nbsp;&nbsp;
																<input type="submit" maxlength="15" size="15" class="btn btn-info" style="max-width: 98px;"
																onClick="return onSubmitApply('hostname_check');" name="x_DDNSHostCheck"
																value="<#LANHostConfig_x_DDNSHostnameCheck_buttonname#>" />
															</div>
														</td>
													</tr>
													<tr id="row_ddns_hname2">
														...
														<td>
															<input type="text" class="input" maxlength="64" size="48" style="width: 286px;"
															name="ddns_hostname2_x" value="<% nvram_get_x(" ","ddns_hostname2_x
															"); %>" onKeyPress="return is_string(this,event);" />
														</td>
													</tr>
													<tr id="row_ddns_hname3">
														...
														<td>
															<input type="text" class="input" maxlength="64" size="48" style="width: 286px;"
															name="ddns_hostname3_x" value="<% nvram_get_x(" ","ddns_hostname3_x
															"); %>" onKeyPress="return is_string(this,event);" />
														</td>
													</tr>
													<tr id="row_ddns_user">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,1);">
																<#LANHostConfig_x_DDNSUserName_itemname#>
															</a>
														</th>
														<td>
															<input type="text" class="input" maxlength="64" size="48" style="width: 286px;"
															name="ddns_username_x" value="<% nvram_get_x(" ","ddns_username_x
															"); %>" onKeyPress="return is_string(this,event);" />
														</td>
													</tr>
													<tr id="row_ddns_pass">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,2);">
																<#LANHostConfig_x_DDNSPassword_itemname#>
															</a>
														</th>
														<td>
															<div class="input-append">
																<input type="password" maxlength="64" class="input" size="32" name="ddns_passwd_x"
																id="ddns_passwd_x" style="width: 175px;" value="<% nvram_get_x(" ","ddns_passwd_x
																"); %>" />
																<button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('ddns_passwd_x')">
													...
													<tr id="row_ddns_ssl" style="display:none;">
														...
														<td>
															<select name="ddns_ssl" class="input">
																<option value="0" <% nvram_match_x( "", "ddns_ssl", "0", "selected");
																%>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns_ssl", "1", "selected");
																%>
																	>
																	<#checkbox_Yes#>
																		(*)
													...
													<tr id="row_ddns_wcard">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,24,4);">
																<#LANHostConfig_x_DDNSWildcard_itemname#>
															</a>
														</th>
														<td>
															<select name="ddns_wildcard_x" class="input">
																<option value="0" <% nvram_match_x( "", "ddns_wildcard_x", "0",
																"selected"); %>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns_wildcard_x", "1",
																"selected"); %>
																	>
																	<#checkbox_Yes#>
																</option>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_ddns2"
												style="display:none;">
													<tr>
													...
													<tr>
														...
														<td>
															...
															&nbsp;
															<a id="ddns2_link" href="javascript:openLink('x_DDNSServer2')" class="label label-info"
															name="x_DDNS2_link">
																<#LANHostConfig_x_DDNSServer_linkname#>
															</a>
														</td>
													...
													<tr id="row_ddns2_hname">
														...
														<td>
															<input type="text" class="input" maxlength="64" size="48" style="width: 286px;"
															name="ddns2_hname" value="<% nvram_get_x(" ","ddns2_hname "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
													</tr>
													<tr id="row_ddns2_user">
														...
														<td>
															<input type="text" class="input" maxlength="64" size="48" style="width: 286px;"
															name="ddns2_user" value="<% nvram_get_x(" ","ddns2_user "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
													</tr>
													<tr id="row_ddns2_pass">
														...
														<td>
															<div class="input-append">
																<input type="password" maxlength="64" class="input" size="32" name="ddns2_pass"
																id="ddns2_pass" style="width: 175px;" value="<% nvram_get_x(" ","ddns2_pass
																"); %>">
																<button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('ddns2_pass')">
																	<i class="if if-btn-eyeclose">
																	</i>
																</button>
															</div>
													...
													<tr id="row_ddns2_ssl" style="display:none;">
														...
														<td>
															<select name="ddns2_ssl" class="input" onchange="disable_update();">
																<option value="0" <% nvram_match_x( "", "ddns2_ssl", "0", "selected");
																%>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns2_ssl", "1", "selected");
																%>
																	>
																	<#checkbox_Yes#>
																		(*)
													...
													<tr id="row_ddns2_wcard">
														...
														<td>
															<select name="ddns2_wildcard_x" class="input">
																<option value="0" <% nvram_match_x( "", "ddns2_wildcard_x", "0",
																"selected"); %>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns2_wildcard_x", "1",
																"selected"); %>
																	>
																	<#checkbox_Yes#>
																</option>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_common"
												style="display:none;">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															<#DDNS_Common#>
													...
													<tr>
														...
														<td>
															<select name="ddns_source" class="input" onchange="change_ddns_source(1)">
																<option value="0" <% nvram_match_x( "", "ddns_source", "0", "selected");
																%>
																	>
																	<#DDNS_AddrExt#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns_source", "1", "selected");
																%>
																	>
																	<#DDNS_AddrWAN#>
																</option>
																<option value="2" <% nvram_match_x( "", "ddns_source", "2", "selected");
																%>
																	>
																	<#DDNS_AddrMAN#>
																</option>
													...
													<tr id="row_ddns_checkip" style="display:none;">
														...
														<td>
															<select name="ddns_checkip" class="input" onchange="disable_update();">
																<option value="0" <% nvram_match_x( "", "ddns_checkip", "0",
																"selected"); %>
																	>
																	<#DDNS_CheckIP_item0#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns_checkip", "1",
																"selected"); %>
																	>checkip.dyndns.org
																</option>
																<option value="2" <% nvram_match_x( "", "ddns_checkip", "2",
																"selected"); %>
																	>checkip.dyndns.org:8245
																</option>
																<option value="3" <% nvram_match_x( "", "ddns_checkip", "3",
																"selected"); %>
																	>ip.dnsexit.com
																</option>
																<option value="4" <% nvram_match_x( "", "ddns_checkip", "4",
																"selected"); %>
																	>ip.changeip.com
																</option>
																<option value="5" <% nvram_match_x( "", "ddns_checkip", "5",
																"selected"); %>
																	>myip.dnsomatic.com
																</option>
																<option value="6" <% nvram_match_x( "", "ddns_checkip", "6",
																"selected"); %>
																	>ip1.dynupdate.no-ip.com
																</option>
																<option value="7" <% nvram_match_x( "", "ddns_checkip", "7",
																"selected"); %>
																	>checkip.dns.he.net (dual stack)
																</option>
																<option value="8" <% nvram_match_x( "", "ddns_checkip", "8",
																"selected"); %>
																	>checkip.two-dns.de
																</option>
																<option value="9" <% nvram_match_x( "", "ddns_checkip", "9",
																"selected"); %>
																	>ip.3322.net
																</option>
																<option value="10" <% nvram_match_x( "", "ddns_checkip", "10",
																"selected"); %>
																	>myip.ipip.net/s
																</option>
																<option value="11" <% nvram_match_x( "", "ddns_checkip", "11",
																"selected"); %>
																	>api.myip.la (dual stack)
																</option>
																<option value="12" <% nvram_match_x( "", "ddns_checkip", "12",
																"selected"); %>
																	>ipv4.wtfismyip.com/text
																</option>
																<option value="13" <% nvram_match_x( "", "ddns_checkip", "13",
																"selected"); %>
																	>ipv6.wtfismyip.com/text
																</option>
																<option value="14" <% nvram_match_x( "", "ddns_checkip", "14",
																"selected"); %>
																	>ipv4.nsupdate.info/myip
																</option>
																<option value="15" <% nvram_match_x( "", "ddns_checkip", "15",
																"selected"); %>
																	>ipv6.nsupdate.info/myip
																</option>
																<option value="16" <% nvram_match_x( "", "ddns_checkip", "16",
																"selected"); %>
																	>api-ipv4.ip.sb/ip
																</option>
																<option value="17" <% nvram_match_x( "", "ddns_checkip", "17",
																"selected"); %>
																	>api-ipv6.ip.sb/ip
																</option>
																<option value="18" <% nvram_match_x( "", "ddns_checkip", "18",
																"selected"); %>
																	>v4.ident.me
																</option>
																<option value="19" <% nvram_match_x( "", "ddns_checkip", "19",
																"selected"); %>
																	>v6.ident.me
																</option>
																<option value="20" <% nvram_match_x( "", "ddns_checkip", "20",
																"selected"); %>
																	>api4.my-ip.io/ip
																</option>
																<option value="21" <% nvram_match_x( "", "ddns_checkip", "21",
																"selected"); %>
																	>api6.my-ip.io/ip
																</option>
																<option value="22" <% nvram_match_x( "", "ddns_checkip", "22",
																"selected"); %>
																	>api.ipify.org
																</option>
																<option value="23" <% nvram_match_x( "", "ddns_checkip", "23",
																"selected"); %>
																	>api6.ipify.org
																</option>
																<option value="24" <% nvram_match_x( "", "ddns_checkip", "24",
																"selected"); %>
																	>ipv4.duiadns.net
																</option>
																<option value="25" <% nvram_match_x( "", "ddns_checkip", "25",
																"selected"); %>
																	>ipv6.duiadns.net
																</option>
																<option value="26" <% nvram_match_x( "", "ddns_checkip", "26",
																"selected"); %>
																	>checkip4.spdyn.de
																</option>
																<option value="27" <% nvram_match_x( "", "ddns_checkip", "27",
																"selected"); %>
																	>checkip6.spdyn.de
																</option>
																<option value="28" <% nvram_match_x( "", "ddns_checkip", "28",
																"selected"); %>
																	>v4.ipv6-test.com/api/myip.php
																</option>
																<option value="29" <% nvram_match_x( "", "ddns_checkip", "29",
																"selected"); %>
													...
													<tr id="row_ddns2_checkip" style="display:none;">
														...
														<td>
															<select name="ddns2_checkip" class="input" onchange="disable_update();">
																<option value="0" <% nvram_match_x( "", "ddns2_checkip", "0",
																"selected"); %>
																	>
																	<#DDNS_CheckIP_item0#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns2_checkip", "1",
																"selected"); %>
																	>checkip.dyndns.org
																</option>
																<option value="2" <% nvram_match_x( "", "ddns2_checkip", "2",
																"selected"); %>
																	>checkip.dyndns.org:8245
																</option>
																<option value="3" <% nvram_match_x( "", "ddns2_checkip", "3",
																"selected"); %>
																	>ip.dnsexit.com
																</option>
																<option value="4" <% nvram_match_x( "", "ddns2_checkip", "4",
																"selected"); %>
																	>ip.changeip.com
																</option>
																<option value="5" <% nvram_match_x( "", "ddns2_checkip", "5",
																"selected"); %>
																	>myip.dnsomatic.com
																</option>
																<option value="6" <% nvram_match_x( "", "ddns2_checkip", "6",
																"selected"); %>
																	>ip1.dynupdate.no-ip.com
																</option>
																<option value="7" <% nvram_match_x( "", "ddns2_checkip", "7",
																"selected"); %>
																	>checkip.dns.he.net (dual stack)
																</option>
																<option value="8" <% nvram_match_x( "", "ddns2_checkip", "8",
																"selected"); %>
																	>checkip.two-dns.de
																</option>
																<option value="9" <% nvram_match_x( "", "ddns2_checkip", "9",
																"selected"); %>
																	>ip.3322.net
																</option>
																<option value="10" <% nvram_match_x( "", "ddns2_checkip", "10",
																"selected"); %>
																	>myip.ipip.net/s
																</option>
																<option value="11" <% nvram_match_x( "", "ddns2_checkip", "11",
																"selected"); %>
																	>api.myip.la (dual stack)
																</option>
																<option value="12" <% nvram_match_x( "", "ddns2_checkip", "12",
																"selected"); %>
																	>ipv4.wtfismyip.com/text
																</option>
																<option value="13" <% nvram_match_x( "", "ddns2_checkip", "13",
																"selected"); %>
																	>ipv6.wtfismyip.com/text
																</option>
																<option value="14" <% nvram_match_x( "", "ddns2_checkip", "14",
																"selected"); %>
																	>ipv4.nsupdate.info/myip
																</option>
																<option value="15" <% nvram_match_x( "", "ddns2_checkip", "15",
																"selected"); %>
																	>ipv6.nsupdate.info/myip
																</option>
																<option value="16" <% nvram_match_x( "", "ddns2_checkip", "16",
																"selected"); %>
																	>api-ipv4.ip.sb/ip
																</option>
																<option value="17" <% nvram_match_x( "", "ddns2_checkip", "17",
																"selected"); %>
																	>api-ipv6.ip.sb/ip
																</option>
																<option value="18" <% nvram_match_x( "", "ddns2_checkip", "18",
																"selected"); %>
																	>v4.ident.me
																</option>
																<option value="19" <% nvram_match_x( "", "ddns2_checkip", "19",
																"selected"); %>
																	>v6.ident.me
																</option>
																<option value="20" <% nvram_match_x( "", "ddns2_checkip", "20",
																"selected"); %>
																	>api4.my-ip.io/ip
																</option>
																<option value="21" <% nvram_match_x( "", "ddns2_checkip", "21",
																"selected"); %>
																	>api6.my-ip.io/ip
																</option>
																<option value="22" <% nvram_match_x( "", "ddns2_checkip", "22",
																"selected"); %>
																	>api.ipify.org
																</option>
																<option value="23" <% nvram_match_x( "", "ddns2_checkip", "23",
																"selected"); %>
																	>api6.ipify.org
																</option>
																<option value="24" <% nvram_match_x( "", "ddns2_checkip", "24",
																"selected"); %>
																	>ipv4.duiadns.net
																</option>
																<option value="25" <% nvram_match_x( "", "ddns2_checkip", "25",
																"selected"); %>
																	>ipv6.duiadns.net
																</option>
																<option value="26" <% nvram_match_x( "", "ddns2_checkip", "26",
																"selected"); %>
																	>checkip4.spdyn.de
																</option>
																<option value="27" <% nvram_match_x( "", "ddns2_checkip", "27",
																"selected"); %>
																	>checkip6.spdyn.de
																</option>
																<option value="28" <% nvram_match_x( "", "ddns2_checkip", "28",
																"selected"); %>
																	>v4.ipv6-test.com/api/myip.php
																</option>
																<option value="29" <% nvram_match_x( "", "ddns2_checkip", "29",
																"selected"); %>
																	>v6.ipv6-test.com/api/myip.php
																</option>
															</select>
													...
													<tr>
														...
														<td>
															<select name="ddns_period" class="input" onchange="disable_update();">
																<option value="0" <% nvram_match_x( "", "ddns_period", "0", "selected");
																%>
																	>10 mins
																</option>
																<option value="1" <% nvram_match_x( "", "ddns_period", "1", "selected");
																%>
																	>1 hour
																</option>
																<option value="2" <% nvram_match_x( "", "ddns_period", "2", "selected");
																%>
																	>2 hours
																</option>
																<option value="3" <% nvram_match_x( "", "ddns_period", "3", "selected");
																%>
																	>3 hours
																</option>
																<option value="6" <% nvram_match_x( "", "ddns_period", "6", "selected");
																%>
																	>6 hours
																</option>
																<option value="12" <% nvram_match_x( "", "ddns_period", "12",
																"selected"); %>
																	>12 hours
																</option>
																<option value="24" <% nvram_match_x( "", "ddns_period", "24",
																"selected"); %>
																	>1 day (*)
																</option>
																<option value="48" <% nvram_match_x( "", "ddns_period", "48",
																"selected"); %>
																	>2 days
																</option>
																<option value="72" <% nvram_match_x( "", "ddns_period", "72",
																"selected"); %>
																	>3 days
																</option>
															</select>
													...
													<tr>
														...
														<td>
															<select name="ddns_forced" class="input" onchange="disable_update();">
																<option value="7" <% nvram_match_x( "", "ddns_forced", "7", "selected");
																%>
																	>7 days
																</option>
																<option value="10" <% nvram_match_x( "", "ddns_forced", "10",
																"selected"); %>
																	>10 days (*)
																</option>
																<option value="20" <% nvram_match_x( "", "ddns_forced", "20",
																"selected"); %>
																	>20 days
																</option>
																<option value="30" <% nvram_match_x( "", "ddns_forced", "30",
																"selected"); %>
																	>30 days
																</option>
															</select>
															&nbsp;
															<input type="submit" maxlength="15" size="15" class="btn btn-info" style="max-width: 94px;"
															onclick="return onSubmitApply('ddnsclient');" name="x_DDNSStatus" value="<#LANHostConfig_x_DDNSStatus_buttonname#>"
															/>
														</td>
													</tr>
													<tr>
														...
														<td>
															<select name="ddns_ipv6" class="input" onchange="disable_update();">
																<option value="0" <% nvram_match_x( "", "ddns_ipv6", "0", "selected");
																%>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "ddns_ipv6", "1", "selected");
																%>
																	>
																	<#checkbox_Yes#>
																</option>
													...
													<tr>
														...
														<td>
															<select name="ddns_verbose" class="input" onchange="disable_update();">
																<option value="0" <% nvram_match_x( "", "ddns_verbose", "0",
																"selected"); %>
																	>0 (Quiet)
																</option>
																<option value="1" <% nvram_match_x( "", "ddns_verbose", "1",
																"selected"); %>
																	>1 (Default)
																</option>
																<option value="2" <% nvram_match_x( "", "ddns_verbose", "2",
																"selected"); %>
																	>2 (Verbose)
																</option>
															</select>
												...
												<table class="table">
													<tr>
														<td style="border-top: 0 none;">
															<center>
																<input type="button" class="btn btn-primary" style="width: 219px" value="<#CTL_apply#>"
																onclick="applyRule();" />
															</center>
														</td>
													</tr>
