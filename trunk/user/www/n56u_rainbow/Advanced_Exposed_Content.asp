										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th width="50%">
															<#IPConnection_ExposedIP_itemname#>
														</th>
														<td>
															<div id="ClientList_Block" class="alert alert-info ddown-list">
															</div>
															<div class="input-append">
																<input type="text" maxlength="15" class="input" size="15" name="dmz_ip"
																value="<% nvram_get_x(" ","dmz_ip "); %>" onkeypress="return is_ipaddr(this,event);"
													...
													<tr>
														<td colspan="2">
															<div class="alert alert-info" style="margin: 2px;">
																<#IPConnection_BattleNet_sectiondesc#>
															</div>
														</td>
													</tr>
													<tr>
														<th width="50%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,7,21);">
																<#IPConnection_BattleNet_itemname#>
															</a>
														</th>
														<td>
															<input type="checkbox" id="sp_battle_ips_fake" <% nvram_match_x( "",
															"sp_battle_ips", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "sp_battle_ips", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="sp_battle_ips" id="sp_battle_ips_1"
																	<% nvram_match_x( "", "sp_battle_ips", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="sp_battle_ips" id="sp_battle_ips_0"
																		<% nvram_match_x( "", "sp_battle_ips", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
