...
function validForm() {
    if ((document.form.fw_lw_enable_x[0].checked == true) && (document.form.filter_lw_date_x_Sun.checked == false) && (document.form.filter_lw_date_x_Mon.checked == false) && (document.form.filter_lw_date_x_Tue.checked == false) && (document.form.filter_lw_date_x_Wed.checked == false) && (document.form.filter_lw_date_x_Thu.checked == false) && (document.form.filter_lw_date_x_Fri.checked == false) && (document.form.filter_lw_date_x_Sat.checked == false)) {
        alert("<#FirewallConfig_LanWanActiveDate_itemname#> <#JS_fieldblank#>");
        return false;
    }

    if (document.form.fw_lw_enable_x[0].checked == true) {
        if (!validate_timerange(document.form.filter_lw_time_x_starthour, 0) || !validate_timerange(document.form.filter_lw_time_x_startmin, 1) || !validate_timerange(document.form.filter_lw_time_x_endhour, 2) || !validate_timerange(document.form.filter_lw_time_x_endmin, 3))
            return false;
...
function changeBgColor(obj, num) {
    $("row" + num).style.background = (obj.checked) ? '#D9EDF7' : 'whiteSmoke';
		...
		<style>
			.nav-tabs > li > a { padding-right: 6px; padding-left: 6px; } .radio.inline
			+ .radio.inline, .checkbox.inline + .checkbox.inline { margin-left: 3px;
			} .table-list td { padding: 6px 4px; } .table-list input, .table-list select
			{ margin-top: 0px; margin-bottom: 0px; } .table-list tr:nth-child(2) {
	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="filter_lw_date_x" value="<% nvram_get_x("
				","filter_lw_date_x "); %>">
				<input type="hidden" name="filter_lw_time_x" value="<% nvram_get_x("
				","filter_lw_time_x "); %>">
				<input type="hidden" name="filter_lw_num_x_0" value="<% nvram_get_x("
				", "filter_lw_num_x "); %>" readonly="1">
									...
									<div class="box well grad_colour_dark_blue">
										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th width="50%" style="padding-bottom: 0px; border-top: 0 none;">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,10,5);">
																<#FirewallConfig_LanWanFirewallEnable_itemname#>
															</a>
														</th>
														<td style="padding-bottom: 0px; border-top: 0 none;">
															<input type="checkbox" id="fw_lw_enable_fake" <% nvram_match_x( "",
															"fw_lw_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "fw_lw_enable_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="fw_lw_enable_x" id="fw_lw_enable_1"
																	onClick="change_lw_enable();" <% nvram_match_x( "", "fw_lw_enable_x",
																	"1", "checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="fw_lw_enable_x" id="fw_lw_enable_0"
																		onClick="change_lw_enable();" <% nvram_match_x( "", "fw_lw_enable_x",
																		"0", "checked"); %>
																		>
																		<#checkbox_No#>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_lwf_main"
												style="display:none">
													<tr>
													...
													<tr>
														<th width="50%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,10,3);">
																<#FirewallConfig_LanWanDefaultAct_itemname#>
															</a>
														</th>
														<td>
															<select name="filter_lw_default_x" class="input">
																<option value="DROP" <% nvram_match_x( "", "filter_lw_default_x",
																"DROP", "selected"); %>
																	>
																	<#WhiteList#>
																</option>
																<option value="ACCEPT" <% nvram_match_x( "", "filter_lw_default_x",
																"ACCEPT", "selected"); %>
																	>
																	<#BlackList#>
																</option>
													...
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,10,1);">
																<#FirewallConfig_LanWanActiveDate_itemname#>
															</a>
														</th>
														<td>
															<div class="controls">
																<label class="checkbox inline">
																	<input type="checkbox" name="filter_lw_date_x_Mon" class="input" onChange="return changeDate();">
																	<#DAY_Mon#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="filter_lw_date_x_Tue" class="input" onChange="return changeDate();">
																	<#DAY_Tue#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="filter_lw_date_x_Wed" class="input" onChange="return changeDate();">
																	<#DAY_Wed#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="filter_lw_date_x_Thu" class="input" onChange="return changeDate();">
																	<#DAY_Thu#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="filter_lw_date_x_Fri" class="input" onChange="return changeDate();">
																	<#DAY_Fri#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="filter_lw_date_x_Sat" class="input" onChange="return changeDate();">
																	<#DAY_Sat#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="filter_lw_date_x_Sun" class="input" onChange="return changeDate();">
																	<#DAY_Sun#>
																</label>
															</div>
														</td>
													...
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,10,2);">
																<#FirewallConfig_LanWanActiveTime_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="filter_lw_time_x_starthour" onKeyPress="return is_number(this,event);"
															/>
															:
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="filter_lw_time_x_startmin" onKeyPress="return is_number(this,event);"
															/>
															-
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="filter_lw_time_x_endhour" onKeyPress="return is_number(this,event);"
															/>
															:
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="filter_lw_time_x_endmin" onKeyPress="return is_number(this,event);"
															/>
														</td>
													</tr>
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,10,4);">
																<#FirewallConfig_LanWanICMP_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="36" class="input" size="32" name="filter_lw_icmp_x"
															value="<% nvram_get_x(" ","filter_lw_icmp_x "); %>" onKeyPress="return is_portlist(this,event)">
														</td>
													</tr>
													<tr>
														<th>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table table-list"
												id="LWFilterList_Block" style="display:none">
													<tr>
													...
													<tr>
														<td>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,3);">
																<#FirewallConfig_LanWanSrcIP_itemname#>
															</a>
														</td>
														<td width="15%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,2);">
																<#FirewallConfig_LanWanSrcPort_itemname#>
															</a>
														</td>
														<td width="25%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,3);">
																<#FirewallConfig_LanWanDstIP_itemname#>
															</a>
														</td>
														<td width="15%" id="col_port_proto">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,2);">
																<#FirewallConfig_LanWanDstPort_itemname#>
															</a>
														</td>
														<td width="15%">
													...
													<tr>
														<td>
															<input type="text" maxlength="15" class="span12" size="14" name="filter_lw_srcip_x_0"
															value="<% nvram_get_x(" ", "filter_lw_srcip_x_0 "); %>" onKeyPress="return is_iprange(this,event);"
															/>
														</td>
														<td>
															<input type="text" maxlength="11" class="span12" size="10" name="filter_lw_srcport_x_0"
															value="<% nvram_get_x(" ", "filter_lw_srcport_x_0 "); %>" onKeyPress="return is_portrange(this,event);"
															/>
														</td>
														<td>
															<input type="text" maxlength="15" class="span12" size="14" name="filter_lw_dstip_x_0"
															value="<% nvram_get_x(" ", "filter_lw_dstip_x_0 "); %>" onKeyPress="return is_iprange(this,event);"
															/>
														</td>
														<td>
															<input type="text" maxlength="11" class="span12" size="10" name="filter_lw_dstport_x_0"
															value="<% nvram_get_x(" ", "filter_lw_dstport_x_0 "); %>" onKeyPress="return is_portrange(this,event);"
															/>
															<input style="display:none" type="text" class="span12" maxlength="3" size="3"
															name="filter_lw_protono_x_0" value="<% nvram_get_x(" ", "filter_lw_protono_x_0
															"); %>" onkeypress="return is_number(this,event);" />
														</td>
														<td>
															<select name="filter_lw_proto_x_0" class="span12" onchange="change_proto()">
																<option value="TCP" <% nvram_match_x( "", "filter_lw_proto_x_0", "TCP",
																"selected"); %>
																	>TCP
																</option>
																<option value="TCP ALL" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"TCP ALL", "selected"); %>
																	>TCP ALL
																</option>
																<option value="TCP SYN" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"TCP SYN", "selected"); %>
																	>TCP SYN
																</option>
																<option value="TCP ACK" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"TCP ACK", "selected"); %>
																	>TCP ACK
																</option>
																<option value="TCP FIN" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"TCP FIN", "selected"); %>
																	>TCP FIN
																</option>
																<option value="TCP RST" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"TCP RST", "selected"); %>
																	>TCP RST
																</option>
																<option value="TCP URG" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"TCP URG", "selected"); %>
																	>TCP URG
																</option>
																<option value="TCP PSH" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"TCP PSH", "selected"); %>
																	>TCP PSH
																</option>
																<option value="UDP" <% nvram_match_x( "", "filter_lw_proto_x_0", "UDP",
																"selected"); %>
																	>UDP
																</option>
																<option value="OTHER" <% nvram_match_x( "", "filter_lw_proto_x_0",
																"OTHER", "selected"); %>
																	>Other
																</option>
															</select>
														...
														<td>
															<button class="btn" type="submit" onclick="return markGroupLWF(this, 64, ' Add ');"
															name="LWFilterList2">
