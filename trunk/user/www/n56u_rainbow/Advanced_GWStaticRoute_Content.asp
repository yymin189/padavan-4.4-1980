	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="sr_num_x_0" value="<% nvram_get_x(" RouterConfig
				", "sr_num_x "); %>" readonly="1">
										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#RouterConfig_GWStaticEnable_sectiondesc#>
												</div>
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														<th width="50%">
															<#RouterConfig_GWDHCPEnable_itemname#>
														</th>
														<td>
															<input type="checkbox" id="dr_enable_x_fake" <% nvram_match_x( "",
															"dr_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "dr_enable_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="dr_enable_x" id="dr_enable_x_1" class="input"
																	<% nvram_match_x( "", "dr_enable_x", "1", "checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="dr_enable_x" id="dr_enable_x_0" class="input"
																		<% nvram_match_x( "", "dr_enable_x", "0", "checked"); %>
																		>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr>
														<th>
															<#RouterConfig_GWStaticEnable_itemname#>
														</th>
														<td>
															<input type="checkbox" id="sr_enable_x_fake" <% nvram_match_x( "",
															"sr_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "sr_enable_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="sr_enable_x" id="sr_enable_x_1" class="input"
																	onclick="change_sr_enabled();" <% nvram_match_x( "", "sr_enable_x", "1",
																	"checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="sr_enable_x" id="sr_enable_x_0" class="input"
																		onclick="change_sr_enabled();" <% nvram_match_x( "", "sr_enable_x", "0",
																		"checked"); %>
																		>
																		<#checkbox_No#>
																</div>
												...
												id="GWStaticList_Block">
													<tr>
														<th colspan="6" style="background-color: #E3E3E3;">
															<#RouterConfig_GWStatic_groupitemdesc#>
														</th>
													</tr>
													<tr>
														<th width="28%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,1);">
																<#RouterConfig_GWStaticIP_itemname#>
															</a>
														</th>
														<th width="22%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,2);">
																<#RouterConfig_GWStaticMask_itemname#>
															</a>
														</th>
														<th width="22%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,3);">
																<#RouterConfig_GWStaticGW_itemname#>
															</a>
														</th>
														<th width="10%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,4);">
																<#RouterConfig_GWStaticMT_itemname#>
															</a>
														</th>
														<th width="13%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6,5);">
													...
													<tr>
														<td>
															<input type="text" maxlength="15" class="span12" size="12" name="sr_ipaddr_x_0"
															value="<% nvram_get_x(" ", "sr_ipaddr_x_0 "); %>" onKeyPress="return is_ipaddr(this,event);"
															/>
														</td>
														<td>
															<input type="text" maxlength="15" class="span12" size="12" name="sr_netmask_x_0"
															value="<% nvram_get_x(" ", "sr_netmask_x_0 "); %>" onKeyPress="return is_ipaddr(this,event);"
															/>
														</td>
														<td>
															<input type="text" maxlength="15" class="span12" size="12" name="sr_gateway_x_0"
															value="<% nvram_get_x(" ", "sr_gateway_x_0 "); %>" onKeyPress="return is_ipaddr(this,event);"
															/>
														</td>
														<td>
															<input type="text" maxlength="3" class="span12" size="1" name="sr_matric_x_0"
															value="<% nvram_get_x(" ", "sr_matric_x_0 "); %>" onkeypress="return is_number(this,event);"
															/>
														</td>
														<td>
															<select name="sr_if_x_0" class="span12">
																<option value="LAN" <% nvram_match_x( "", "sr_if_x_0", "LAN",
																"selected"); %>
																	>LAN
																</option>
																<option value="MAN" <% nvram_match_x( "", "sr_if_x_0", "MAN",
																"selected"); %>
																	>MAN
																</option>
																<option value="WAN" <% nvram_match_x( "", "sr_if_x_0", "WAN",
																"selected"); %>
																	>WAN
																</option>
															</select>
														...
														<td>
															<button class="btn" type="submit" onClick="return GWStatic_markGroup(this, 64, ' Add ');"
															name="GWStatic2">
