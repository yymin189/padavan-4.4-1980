										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													...
													<tr id="row_mroute">
														<th>
															<#RouterConfig_GWMulticastEnable_itemname#>
														</th>
														<td>
															<input type="checkbox" id="mr_enable_x_fake" <% nvram_match_x( "",
															"mr_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "mr_enable_x", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="mr_enable_x" id="mr_enable_x_1" class="input"
																	onclick="on_click_mroute();" <% nvram_match_x( "", "mr_enable_x", "1",
																	"checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="mr_enable_x" id="mr_enable_x_0" class="input"
																		onclick="on_click_mroute();" <% nvram_match_x( "", "mr_enable_x", "0",
																		"checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<tr id="row_qleave" style="display:none;">
														...
														<td>
															<select name="mr_qleave_x" class="input">
																<option value="0" <% nvram_match_x( "", "mr_qleave_x", "0", "selected");
																%>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "mr_qleave_x", "1", "selected");
																%>
																	>
																	<#checkbox_Yes#>
																		(*)
													...
													<tr>
														...
														<td>
															<select name="force_igmp" class="input">
																<option value="0" <% nvram_match_x( "", "force_igmp", "0", "selected");
																%>
																	>
																	<#checkbox_No#>
																		(*)
																</option>
																<option value="1" <% nvram_match_x( "", "force_igmp", "1", "selected");
																%>
																	>IGMPv1
																</option>
																<option value="2" <% nvram_match_x( "", "force_igmp", "2", "selected");
																%>
																	>IGMPv2
																</option>
															</select>
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														<th width="50%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6, 6);">
																<#RouterConfig_IPTV_itemname#>
																	:
															</a>
														</th>
														<td>
															<input type="text" maxlength="5" class="input" size="15" name="udpxy_enable_x"
															value="<% nvram_get_x(" ", "udpxy_enable_x "); %>" onkeypress="return is_number(this,event);"
															onblur="valid_udpxy();" />
														</td>
														<td width="15%">
															<a href="javascript:on_udpxy_link();" id="web_udpxy_link">
																Web status
															</a>
														</td>
													</tr>
													<tr id="row_xupnpd">
														...
														<td>
															<input type="text" maxlength="5" class="input" size="15" name="xupnpd_enable_x"
															value="<% nvram_get_x(" ", "xupnpd_enable_x "); %>" onkeypress="return is_number(this,event);"
															onblur="valid_xupnpd();" />
														</td>
														<td width="15%">
															<a href="javascript:on_xupnpd_link();" id="web_xupnpd_link">
																Web status
															</a>
														</td>
													</tr>
													<tr id="row_xupnpd_udpxy" style="display:none;">
														...
														<td colspan="2">
															<select name="xupnpd_udpxy" class="input">
																<option value="0" <% nvram_match_x( "", "xupnpd_udpxy", "0",
																"selected"); %>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "xupnpd_udpxy", "1",
																"selected"); %>
																	>
																	<#checkbox_Yes#>
																</option>
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="ether_igmp_fake" <% nvram_match_x( "",
															"ether_igmp", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "ether_igmp", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ether_igmp" id="ether_igmp_1" class="input"
																	onclick="on_click_snoop();" <% nvram_match_x( "", "ether_igmp", "1",
																	"checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ether_igmp" id="ether_igmp_0" class="input"
																		onclick="on_click_snoop();" <% nvram_match_x( "", "ether_igmp", "0",
																		"checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<tr id="row_m2u_wire">
														...
														<td>
															<select name="ether_m2u" class="input" onchange="on_change_m2u_wire();">
																<option value="0" <% nvram_match_x( "", "ether_m2u", "0", "selected");
																%>
																	>
																	<#btn_Disable#>
																</option>
																<option value="1" <% nvram_match_x( "", "ether_m2u", "1", "selected");
																%>
																	>Multicast to Unicast
																</option>
																<option value="2" <% nvram_match_x( "", "ether_m2u", "2", "selected");
																%>
																	>HW IGMP/MLD snooping (*)
																</option>
															</select>
														</td>
													</tr>
													<tr id="row_igmp_uport">
														...
														<td>
															<select name="ether_uport" class="input">
																<option value="-1" <% nvram_match_x( "", "ether_uport", "-1",
																"selected"); %>
																	>
																	<#checkbox_No#>
																</option>
																<option value="0" <% nvram_match_x( "", "ether_uport", "0", "selected");
																%>
																	>WAN (*)
																</option>
																<option value="1" <% nvram_match_x( "", "ether_uport", "1", "selected");
																%>
																	>LAN1
																</option>
																<option value="2" <% nvram_match_x( "", "ether_uport", "2", "selected");
																%>
																	>LAN2
																</option>
																<option value="3" <% nvram_match_x( "", "ether_uport", "3", "selected");
																%>
																	>LAN3
																</option>
																<option value="4" <% nvram_match_x( "", "ether_uport", "4", "selected");
																%>
																	>LAN4
																</option>
																<option value="5" <% nvram_match_x( "", "ether_uport", "5", "selected");
																%>
																	>LAN5
																</option>
																<option value="6" <% nvram_match_x( "", "ether_uport", "6", "selected");
																%>
																	>LAN6
																</option>
																<option value="7" <% nvram_match_x( "", "ether_uport", "7", "selected");
																%>
																	>LAN7
																</option>
																<option value="13" <% nvram_match_x( "", "ether_uport", "13",
																"selected"); %>
																	>iNIC (2.4GHz)
																</option>
															</select>
													...
													<tr id="row_m2u_2ghz">
														...
														<td>
															<select name="rt_IgmpSnEnable" class="input">
																<option value="0" <% nvram_match_x( "", "rt_IgmpSnEnable", "0",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
																<option value="1" <% nvram_match_x( "", "rt_IgmpSnEnable", "1",
																"selected"); %>
																	>Multicast to Unicast (*)
																</option>
															</select>
													...
													<tr id="row_m2u_5ghz">
														...
														<td>
															<select name="wl_IgmpSnEnable" class="input">
																<option value="0" <% nvram_match_x( "", "wl_IgmpSnEnable", "0",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
																<option value="1" <% nvram_match_x( "", "wl_IgmpSnEnable", "1",
																"selected"); %>
																	>Multicast to Unicast (*)
																</option>
															</select>
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													...
													<tr id="row_storm_ucast">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this, 6, 7);">
																<#RouterConfig_GWMulticast_unknownUni_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="4" class="input" size="15" name="controlrate_unknown_unicast"
															value="<% nvram_get_x(" ", "controlrate_unknown_unicast "); %>" onkeypress="return is_number(this,event);"
															/>
															&nbsp;
													...
													<tr id="row_storm_mcast_unk">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this, 6, 8);">
																<#RouterConfig_GWMulticast_unknownMul_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="4" class="input" size="15" name="controlrate_unknown_multicast"
															value="<% nvram_get_x(" ", "controlrate_unknown_multicast "); %>" onkeypress="return is_number(this,event);"
															/>
															&nbsp;
															<span style="color:#888;">
															</span>
													...
													<tr id="row_storm_mcast">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this, 6, 9);">
																<#RouterConfig_GWMulticast_Multicast_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="4" class="input" size="15" name="controlrate_multicast"
															value="<% nvram_get_x(" ", "controlrate_multicast "); %>" onkeypress="return is_number(this,event);"
															/>
															&nbsp;
															<span style="color:#888;">
																[0..1000]
													...
													<tr>
														<th width="50%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this, 6, 10);">
																<#RouterConfig_GWMulticast_Broadcast_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="4" class="input" size="15" name="controlrate_broadcast"
															value="<% nvram_get_x(" ", "controlrate_broadcast "); %>" onkeypress="return is_number(this,event);"
															/>
															&nbsp;
															<span id="lbl_bcast" style="color:#888;">
																[0..1000]
															</span>
														</td>
													</tr>
