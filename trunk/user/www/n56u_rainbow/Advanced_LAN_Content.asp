										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#LANHostConfig_display1_sectiondesc#>
												</div>
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td style="border-top: 0 none;">
															<input type="text" maxlength="15" class="input" size="15" id="lan_ipaddr"
															name="lan_ipaddr" value="<% nvram_get_x(" LANHostConfig ","lan_ipaddr
													...
													<tr>
														...
														<td>
															...
															value="<% nvram_get_x(" LANHostConfig ","lan_netmask "); %>" onkeypress="return is_ipaddr(this,event);"
															/>
															&nbsp;
															<span style="color:#888;">
																255.255.255.0
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="lan_stp_fake" <% nvram_match_x( "",
															"lan_stp", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "lan_stp", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="lan_stp" id="lan_stp_1" <% nvram_match_x(
																	"", "lan_stp", "1", "checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="lan_stp" id="lan_stp_0" <% nvram_match_x(
																		"", "lan_stp", "0", "checked"); %>
																		>
																		<#checkbox_No#>
																</div>
