...
function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-firewall', 4);
    show_footer();
...
function showMFList() {
    ...
    if (MACList.length == 0) {
        ...
        code += '<td><button class="btn btn-danger" type="submit" onclick="return markGroupMAC(this, 64, \' Del \');" name="MFList"><i class="if if-btn-minus"></i></button></td>';
        code += '</tr>';
	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="macfilter_num_x_0" value="<% nvram_get_x("
				", "macfilter_num_x "); %>" readonly="1" />
										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#FirewallConfig_display5_sectiondesc#>
												</div>
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th width="50%" style="border-top: 0 none;">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,1);">
																<#FirewallConfig_MFMethod_itemname#>
															</a>
														</th>
														<td style="border-top: 0 none;">
															<select name="macfilter_enable_x" class="input" onchange="change_macfilter()">
																<option value="0" <% nvram_match_x( "", "macfilter_enable_x", "0",
																"selected"); %>
																	>
																	<#CTL_Disabled#>
																</option>
																<option value="1" <% nvram_match_x( "", "macfilter_enable_x", "1",
																"selected"); %>
																	>
																	<#FirewallConfig_MFMethod_item1#>
																</option>
																<option value="2" <% nvram_match_x( "", "macfilter_enable_x", "2",
																"selected"); %>
																	>
																	<#FirewallConfig_MFMethod_item2#>
																</option>
															</select>
														</td>
													</tr>
													<tr id="mac_drop_row" style="display:none;">
														...
														<td>
															<input type="checkbox" id="fw_mac_drop_fake" <% nvram_match_x( "",
															"fw_mac_drop", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "fw_mac_drop", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="fw_mac_drop" id="fw_mac_drop_1" <%
																	nvram_match_x( "", "fw_mac_drop", "1", "checked"); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="fw_mac_drop" id="fw_mac_drop_0" <%
																		nvram_match_x( "", "fw_mac_drop", "0", "checked"); %>
																		>
																		<#checkbox_No#>
																</div>
														</td>
												...
												id="MFList_Block">
													...
													<tr>
														<th width="25%">
															<#FirewallConfig_MFhwaddr_itemname#>
														</th>
														<th width="25%">
															<#MAC_Time#>
														</th>
													...
													<tr>
														<td width="25%">
															...
															<div class="input-append">
																<input type="text" maxlength="12" class="span12" size="12" name="macfilter_list_x_0"
																value="<% nvram_get_x(" ", "macfilter_list_x_0 "); %>" onKeyPress="return is_hwaddr(event);"
														...
														<td width="25%">
															<input type="text" maxlength="2" class="input" style="width: 18px;" size="2"
															name="macfilter_time_x_starthour" onKeyPress="return is_number(this,event);"
															/>
															:
															<input type="text" maxlength="2" class="input" style="width: 18px;" size="2"
															name="macfilter_time_x_startmin" onKeyPress="return is_number(this,event);"
															/>
															&nbsp;-
															<input type="text" maxlength="2" class="input" style="width: 18px;" size="2"
															name="macfilter_time_x_endhour" onKeyPress="return is_number(this,event);"
															/>
															:
															<input type="text" maxlength="2" class="input" style="width: 18px;" size="2"
															name="macfilter_time_x_endmin" onKeyPress="return is_number(this,event);"
															/>
														</td>
														<td width="45%">
															<div class="controls">
																<label class="checkbox inline">
																	<input type="checkbox" name="macfilter_date_x_Mon" class="input">
																	<#DAY_Mon#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="macfilter_date_x_Tue" class="input">
																	<#DAY_Tue#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="macfilter_date_x_Wed" class="input">
																	<#DAY_Wed#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="macfilter_date_x_Thu" class="input">
																	<#DAY_Thu#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="macfilter_date_x_Fri" class="input">
																	<#DAY_Fri#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="macfilter_date_x_Sat" class="input">
																	<#DAY_Sat#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="macfilter_date_x_Sun" class="input">
																	<#DAY_Sun#>
																</label>
															</div>
														</td>
														<td width="5%">
															<button class="btn" style="max-width: 219px" type="submit" onclick="return markGroupMAC(this, 64, ' Add ');"
															name="MFList2" value="<#CTL_add#>" size="12">
