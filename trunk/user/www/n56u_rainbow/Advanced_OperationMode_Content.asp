										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div style="margin-left: 10px; margin-top: 10px;">
													<div class="controls">
														<label class="radio inline">
															<div id="wl_rt" style="display:none;">
																<input type="radio" name="sw_mode" class="input" value="1" onclick="setScenerion(1);"
																<% nvram_match_x( "IPConnection", "sw_mode", "1", "checked"); %>
																>
																<#OP_GW_item#>
															</div>
														</label>
														<label class="radio inline">
															<div id="rt_wo_nat" style="display:none;">
																<input type="radio" name="sw_mode" class="input" value="4" onclick="setScenerion(4);"
																<% nvram_match_x( "IPConnection", "sw_mode", "4", "checked"); %>
																>
																<#OP_GW_item#>
															</div>
														</label>
														<label class="radio inline">
															<div id="wl_ap">
																<input type="radio" name="sw_mode" class="input" value="3" onclick="setScenerion(3);"
																<% nvram_match_x( "IPConnection", "sw_mode", "3", "checked"); %>
																>
																<#OP_AP_item#>
															</div>
														</label>
													</div>
													<div id="mode_desc" style="margin-left: 0px; margin-top: 10px; margin-right: 10px;"
												...
												<div style="margin-top: 10px; margin-right: 10px; margin-left: 10px;">
													<center>
														<div id="Senario" class="span12" style="height: 170px;">
															<div class="row-fluid">
																<table style="width: 100%">
																	...
																	<tr>
																		<td>
																			<i class="if if-workmode-wirelessdevices">
																			</i>
																		</td>
																		<td>
																			<i class="if if-workmode-arrowleft">
																			</i>
																		</td>
																		<td>
																			<i class="if if-workmode-wirelessrouter">
																			</i>
																		</td>
																		<td class="AP">
																			<i class="if if-workmode-arrowleft">
																		...
																		<td class="AP">
																			<i class="if if-workmode-mainrouter">
																			</i>
																		</td>
																		<td>
																			<i class="if if-workmode-arrowleft">
																		...
																		<td>
																			<i class="if if-workmode-internet">
																			</i>
																		</td>
																	</tr>
																</table>
															</div>
															<div id="ap-line" style="display: none;position: absolute; margin-left: -10000px">
															</div>
														</div>
													</center>
												</div>
												<center>
													...
													onClick="saveMode();" value="<#CTL_onlysave#>">
												</center>
												<br/>
											</div>
										</div>
