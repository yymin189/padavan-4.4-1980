...
$j.fn.fileName = function() {
    ...
    if (newVal !== '') {
		...
		<style>
			.file { display: inline-block; width:100px; position: relative; -moz-border-radius:
			4px; -webkit-border-radius:4px; border-radius: 4px; margin-bottom:10px;
			text-align: center; background-color: #f5f5f5; *background-color: #e6e6e6;
			background-image: -ms-linear-gradient(top, #ffffff, #e6e6e6); background-image:
			-webkit-gradient(linear, 0 0, 0 100%, from(#ffffff), to(#e6e6e6)); background-image:
			-webkit-linear-gradient(top, #ffffff, #e6e6e6); background-image: -o-linear-gradient(top,
			#ffffff, #e6e6e6); background-image: linear-gradient(top, #ffffff, #e6e6e6);
			background-image: -moz-linear-gradient(top, #ffffff, #e6e6e6); border:
			1px solid #ddd; } /* style text of the upload field and add an attachment
			icon */ .file .button { font-family: "Helvetica Neue", Helvetica, Arial,
			sans-serif; font-size:11px; color:#555; height:27px; line-height:26px;
			display: block; } /* hide the real file upload input field */ .file input
			{ cursor: pointer; height: 100%; position: absolute; right: 0; top: 0;
			filter: alpha(opacity=1); -moz-opacity: 0.01; font-size: 100px; }
		</style>
	</head>
	<body onload="initial();">
		...
		<div class="wrapper">
					...
					<div class="container-fluid" style="margin-top: 150px;">
						<div class="well" style="background-color: #212121; width: 60%;">
							<div class="progress" style="max-width: 450px; text-align: left;">
								<div class="bar" id="proceeding_img">
									<span id="proceeding_img_text">
									</span>
								</div>
							</div>
			...
			<form method="post" name="form" action="upload.cgi" target="hidden_frame"
			enctype="multipart/form-data">
				...
				"); %>">
				<input type="hidden" name="mtd_rwfs_mount" value="<% nvram_get_x("
				", "mtd_rwfs_mount "); %>">
											...
											<div class="row-fluid">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr id="row_nv_reset" style="display:none">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,19,1)">
																<#Setting_factorydefault_itemname#>
															</a>
														</th>
														<td>
															<input name="action1" class="btn btn-danger" style="width: 219px;" onclick="restoreNVRAM();"
															type="button" value="<#CTL_restore#>" />
														</td>
													</tr>
													<tr id="row_nv_backup" style="display:none">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,19,2)">
																<#Setting_save_itemname#>
															</a>
														</th>
														<td>
															<input name="action2" class="btn btn-info" style="width: 219px;" onclick="saveSetting();"
															type="button" value="<#CTL_onlysave#>" />
														</td>
													</tr>
													<tr id="row_nv_restore1" style="display:none">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,19,3)">
													...
													<tr id="row_nv_restore2" style="display:none">
														<th style="border-top: 0 none; padding-top: 0px;">
														</th>
														<td style="border-top: 0 none; padding-top: 0px;">
															<input name="upload_nv" class="btn btn-info" style="width: 219px;" onclick="uploadSetting();"
															type="button" value="<#CTL_upload#>" />
														</td>
													</tr>
													<tr>
														<th width="50%">
															<#Adm_Setting_commit_mode#>
														</th>
														<td align="left">
															<select class="input" name="nvram_manual_fake" onchange="applyRule();">
																<option value="0" <% nvram_match_x( "", "nvram_manual", "0",
																"selected"); %>
																	>
																	<#Adm_Setting_commit_item0#>
																		(*)
																</option>
																<option value="1" <% nvram_match_x( "", "nvram_manual", "1",
																"selected"); %>
																	>
																	<#Adm_Setting_commit_item1#>
																</option>
															</select>
														</td>
													</tr>
													<tr>
														<th>
															<#Adm_Setting_commit_now#>
														</th>
														<td>
															<button type="button" name="commit_nvram" id="commit_nvram" class="btn"
															style="width: 219px; outline: 0">
																<#CTL_Commit#>
															</button>
														</td>
													</tr>
												</table>
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_rwfs"
												style="display:none">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															<#Adm_Setting_rwfs#>
													...
													<tr>
														<th width="50%">
															<#Adm_Setting_rwfs_mount#>
														</th>
														<td align="left">
															<select class="input" name="mtd_rwfs_mount_fake" onchange="applyRule();">
																<option value="0" <% nvram_match_x( "", "mtd_rwfs_mount", "0",
																"selected"); %>
																	>
																	<#checkbox_No#>
																		(*)
																</option>
																<option value="1" <% nvram_match_x( "", "mtd_rwfs_mount", "1",
																"selected"); %>
																	>UBIFS
																</option>
															</select>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr id="row_st_reset" style="display:none">
														...
														<td colspan="2">
															<input name="st_action1" class="btn btn-danger" style="width: 219px;"
															type="button" value="<#CTL_restore#>" onclick="restoreStorage();" />
														</td>
													</tr>
													<tr id="row_st_backup" style="display:none">
														<th>
															<#Adm_Setting_store_backup#>
														</th>
														<td>
															<input name="st_action2" class="btn btn-info" style="width: 219px;" onclick="saveStorage();"
															type="button" value="<#CTL_onlysave#>" />
														</td>
													</tr>
													<tr id="row_st_restore1" style="display:none">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,19,4)">
																<#Storage_upload_itemname#>
															</a>
														</th>
														<td>
													...
													<tr id="row_st_restore2" style="display:none">
														...
														<td style="border-top: 0 none; padding-top: 0px;">
															<input name="upload_st" class="btn btn-info" style="width: 219px;" onclick="uploadStorage();"
															type="button" value="<#CTL_upload#>" />
														</td>
													</tr>
													<tr>
														<th width="50%">
															<#Adm_Setting_store_stats#>
														</th>
														<td align="left">
															<select class="input" name="rstats_stored_fake" onchange="applyRule();">
																<option value="0" <% nvram_match_x( "", "rstats_stored", "0",
																"selected"); %>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "rstats_stored", "1",
																"selected"); %>
																	>
																	<#Adm_Setting_store_stats_item1#>
																		(*)
																</option>
																<option value="2" <% nvram_match_x( "", "rstats_stored", "2",
																"selected"); %>
																	>
																	<#Adm_Setting_store_stats_item2#>
																</option>
																<option value="3" <% nvram_match_x( "", "rstats_stored", "3",
																"selected"); %>
																	>
																	<#Adm_Setting_store_stats_item3#>
																</option>
																<option value="4" <% nvram_match_x( "", "rstats_stored", "4",
																"selected"); %>
																	>
																	<#Adm_Setting_store_stats_item4#>
																</option>
																<option value="5" <% nvram_match_x( "", "rstats_stored", "5",
																"selected"); %>
																	>
																	<#Adm_Setting_store_stats_item5#>
																</option>
																<option value="6" <% nvram_match_x( "", "rstats_stored", "6",
																"selected"); %>
																	>
																	<#Adm_Setting_store_stats_item6#>
																		(!)
																</option>
																<option value="7" <% nvram_match_x( "", "rstats_stored", "7",
																"selected"); %>
																	>
																	<#Adm_Setting_store_stats_item7#>
																		(!)
																</option>
															</select>
														</td>
													...
													<tr>
														<th>
															<#Adm_Setting_store_stime#>
														</th>
														<td align="left">
															<select class="input" name="stime_stored_fake" onchange="applyRule();">
																<option value="1" <% nvram_match_x( "", "stime_stored", "1",
																"selected"); %>
																	>
																	<#checkbox_Yes#>
																		(*)
																</option>
																<option value="0" <% nvram_match_x( "", "stime_stored", "0",
																"selected"); %>
																	>
																	<#checkbox_No#>
																</option>
													...
													<tr>
														<th>
															<#Adm_Setting_store_now#>
														</th>
														<td colspan="2">
															<button type="button" name="commit_storage" id="commit_storage" class="btn"
															style="width: 219px; outline: 0">
																<#CTL_Commit#>
															</button>
														</td>
