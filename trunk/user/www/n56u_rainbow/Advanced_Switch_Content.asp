...
function show_links() {
    ...
    if (support_led_phy() > 0)
        led0 = parseInt("<% nvram_get_x("
            ","
            ether_led0 "); %>");
    if (support_led_phy() > 1)
        led1 = parseInt("<% nvram_get_x("
            ","
            ether_led1 "); %>");
											...
											<div class="row-fluid">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr id="row_ether_jumbo">
														...
														<td>
															<select name="ether_jumbo" class="input">
																<option value="0" <% nvram_match_x( "", "ether_jumbo", "0", "selected");
																%>
																	>Up to 1536 bytes
																</option>
																<option value="1" <% nvram_match_x( "", "ether_jumbo", "1", "selected");
																%>
																	>Up to 16000 bytes
																</option>
															</select>
													...
													<tr id="row_ether_green">
														...
														<td>
															<input type="checkbox" id="ether_green_fake" <% nvram_match_x( "",
															"ether_green", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "ether_green", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ether_green" id="ether_green_1" class="input"
																	<% nvram_match_x( "", "ether_green", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ether_green" id="ether_green_0" class="input"
																		<% nvram_match_x( "", "ether_green", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th colspan="2" align="center" style="background-color: #E3E3E3;">
															WAN
														</th>
													</tr>
													<tr>
												...
												style="display:none;">
													...
													<tr>
														...
														<td id="linkstate_lan4">
														</td>
													</tr>
												</table>
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_ephy_l5"
												style="display:none;">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															LAN 5
													...
													<tr>
														...
														<td id="linkstate_lan5">
														</td>
													</tr>
												</table>
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_ephy_l6"
												style="display:none;">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															LAN 6
													...
													<tr>
														...
														<td id="linkstate_lan6">
														</td>
													</tr>
												</table>
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_ephy_l7"
												style="display:none;">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															LAN 7
