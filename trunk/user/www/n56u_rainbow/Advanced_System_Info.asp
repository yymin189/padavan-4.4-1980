										...
										<div class="row-fluid">
											...
											<div id="tab-area" style="margin-bottom: 0px;">
												<ul id="tabs" class="nav nav-tabs">
													<li>
														<a href="#CPU" id="tab_cpu_chart">
															<#menu5_8_1#>
														</a>
													</li>
													<li>
														<a href="#MEM" id="tab_mem_chart">
															<#menu5_8_2#>
														</a>
													</li>
												</ul>
												...
												<table style="width: 100%; margin-top: 6px; margin-bottom: 6px;">
													<tr>
														<td width="100%" align="center" style="text-align: center">
															<div id="cpu_chart" style="width: 850px; padding-left: 5px;">
															</div>
															<div id="mem_chart" style="width: 850px; padding-left: 5px;">
															</div>
														</td>
													</tr>
												</table>
