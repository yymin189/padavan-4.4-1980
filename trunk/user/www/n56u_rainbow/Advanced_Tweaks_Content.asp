...
function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-sysparams', 1);
    show_footer();
									...
									<div class="box well grad_colour_dark_blue">
										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_fn1_actions"
												style="display:none;">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															<#TweaksFN1Action#>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_fn2_actions"
												style="display:none;">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															<#TweaksFN2Action#>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="front_led_all_fake" <% nvram_match_x( "",
															"front_led_all", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "front_led_all", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="front_led_all" id="front_led_all_1"
																	class="input" onclick="change_led_all();" <% nvram_match_x( "",
																	"front_led_all", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="front_led_all" id="front_led_all_0"
																		class="input" onclick="change_led_all();" <% nvram_match_x( "",
																		"front_led_all", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr id="row_led_wan">
														...
														<td>
															<select name="front_led_wan" class="input">
																<option value="0" <% nvram_match_x( "", "front_led_wan", "0",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
																<option value="1" <% nvram_match_x( "", "front_led_wan", "1",
																"selected"); %>
																	>
																	<#TweaksLEDItem00#>
																</option>
																<option value="2" <% nvram_match_x( "", "front_led_wan", "2",
																"selected"); %>
																	>
																	<#TweaksLEDItem03#>
																		(*)
																</option>
																<option value="3" <% nvram_match_x( "", "front_led_wan", "3",
																"selected"); %>
																	>
																	<#TweaksLEDItem04#>
																</option>
													...
													<tr id="row_led_lan" style="display:none;">
														...
														<td>
															<select name="front_led_lan" class="input">
																<option value="0" <% nvram_match_x( "", "front_led_lan", "0",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
																<option value="1" <% nvram_match_x( "", "front_led_lan", "1",
																"selected"); %>
																	>
																	<#TweaksLEDItem00#>
																		(*)
																</option>
																<option value="2" <% nvram_match_x( "", "front_led_lan", "2",
																"selected"); %>
																	>
																	<#TweaksLEDItem01#>
																</option>
																<option value="3" <% nvram_match_x( "", "front_led_lan", "3",
																"selected"); %>
																	>
																	<#TweaksLEDItem02#>
																</option>
													...
													<tr id="row_led_usb" style="display:none;">
														...
														<td>
															<select name="front_led_usb" class="input">
																<option value="0" <% nvram_match_x( "", "front_led_usb", "0",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
																<option value="1" <% nvram_match_x( "", "front_led_usb", "1",
																"selected"); %>
																	>
																	<#TweaksLEDItem05#>
																		(*)
																</option>
																<option value="2" <% nvram_match_x( "", "front_led_usb", "2",
																"selected"); %>
																	>
																	<#TweaksLEDItem06#>
																</option>
																<option value="3" <% nvram_match_x( "", "front_led_usb", "3",
																"selected"); %>
																	>
																	<#TweaksLEDItem07#>
																</option>
													...
													<tr id="row_led_wif" style="display:none;">
														...
														<td>
															<select name="front_led_wif" class="input">
																<option value="0" <% nvram_match_x( "", "front_led_wif", "0",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
																<option value="1" <% nvram_match_x( "", "front_led_wif", "1",
																"selected"); %>
																	>
																	<#TweaksLEDItem09#>
																		(*)
													...
													<tr id="row_led_pwr">
														...
														<td>
															<select name="front_led_pwr" class="input">
																<option value="0" <% nvram_match_x( "", "front_led_pwr", "0",
																"selected"); %>
																	>
																	<#btn_Disable#>
																		,
																...
																<option value="1" <% nvram_match_x( "", "front_led_pwr", "1",
																"selected"); %>
																	>
																	<#btn_Enable#>
																		,
													...
													<tr id="row_eth_phy_led0">
														...
														<td>
															<select name="ether_led0" class="input">
																<option value="0" <% nvram_match_x( "", "ether_led0", "0", "selected");
																%>
																	>Link 1000 Mbps, TX/RX activity
																</option>
																<option value="1" <% nvram_match_x( "", "ether_led0", "1", "selected");
																%>
																	>Link 100 Mbps, TX/RX activity
																</option>
																<option value="2" <% nvram_match_x( "", "ether_led0", "2", "selected");
																%>
																	>Link 10 Mbps, TX/RX activity
																</option>
																<option value="3" <% nvram_match_x( "", "ether_led0", "3", "selected");
																%>
																	>Link 100/10 Mbps, TX/RX activity (*)
																</option>
																<option value="4" <% nvram_match_x( "", "ether_led0", "4", "selected");
																%>
																	>Link 1000 Mbps
																</option>
																<option value="5" <% nvram_match_x( "", "ether_led0", "5", "selected");
																%>
																	>Link 100 Mbps
																</option>
																<option value="6" <% nvram_match_x( "", "ether_led0", "6", "selected");
																%>
																	>Link 10 Mbps
																</option>
																<option value="7" <% nvram_match_x( "", "ether_led0", "7", "selected");
																%>
																	>Link, TX/RX activity
																</option>
																<option value="8" <% nvram_match_x( "", "ether_led0", "8", "selected");
																%>
																	>Link, RX activity
																</option>
																<option value="9" <% nvram_match_x( "", "ether_led0", "9", "selected");
																%>
																	>Link, TX activity
																</option>
																<option value="10" <% nvram_match_x( "", "ether_led0", "10",
																"selected"); %>
																	>Duplex, Collision
																</option>
																<option value="11" <% nvram_match_x( "", "ether_led0", "11",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
													...
													<tr id="row_eth_phy_led1">
														...
														<td>
															<select name="ether_led1" class="input">
																<option value="0" <% nvram_match_x( "", "ether_led1", "0", "selected");
																%>
																	>Link 1000 Mbps, TX/RX activity (*)
																</option>
																<option value="1" <% nvram_match_x( "", "ether_led1", "1", "selected");
																%>
																	>Link 100 Mbps, TX/RX activity
																</option>
																<option value="2" <% nvram_match_x( "", "ether_led1", "2", "selected");
																%>
																	>Link 10 Mbps, TX/RX activity
																</option>
																<option value="3" <% nvram_match_x( "", "ether_led1", "3", "selected");
																%>
																	>Link 100/10 Mbps, TX/RX activity
																</option>
																<option value="4" <% nvram_match_x( "", "ether_led1", "4", "selected");
																%>
																	>Link 1000 Mbps
																</option>
																<option value="5" <% nvram_match_x( "", "ether_led1", "5", "selected");
																%>
																	>Link 100 Mbps
																</option>
																<option value="6" <% nvram_match_x( "", "ether_led1", "6", "selected");
																%>
																	>Link 10 Mbps
																</option>
																<option value="7" <% nvram_match_x( "", "ether_led1", "7", "selected");
																%>
																	>Link, TX/RX activity
																</option>
																<option value="8" <% nvram_match_x( "", "ether_led1", "8", "selected");
																%>
																	>Link, RX activity
																</option>
																<option value="9" <% nvram_match_x( "", "ether_led1", "9", "selected");
																%>
																	>Link, TX activity
																</option>
																<option value="10" <% nvram_match_x( "", "ether_led1", "10",
																"selected"); %>
																	>Duplex, Collision
																</option>
																<option value="11" <% nvram_match_x( "", "ether_led1", "11",
																"selected"); %>
																	>
																	<#btn_Disable#>
																</option>
