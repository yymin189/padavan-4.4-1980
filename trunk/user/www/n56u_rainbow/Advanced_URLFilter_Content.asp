...
function validForm() {
    if ((document.form.url_enable_x[0].checked == true) && (document.form.url_date_x_Sun.checked == false) && (document.form.url_date_x_Mon.checked == false) && (document.form.url_date_x_Tue.checked == false) && (document.form.url_date_x_Wed.checked == false) && (document.form.url_date_x_Thu.checked == false) && (document.form.url_date_x_Fri.checked == false) && (document.form.url_date_x_Sat.checked == false)) {
        alert("<#FirewallConfig_URLActiveDate_itemname#><#JS_fieldblank#>");
        return false;
    }

    if (document.form.url_enable_x[0].checked == true) {
        if (!validate_timerange(document.form.url_time_x_starthour, 0) || !validate_timerange(document.form.url_time_x_startmin, 1) || !validate_timerange(document.form.url_time_x_endhour, 2) || !validate_timerange(document.form.url_time_x_endmin, 3)) {
            return false;
        }
...
function done_validating(action) {
    refreshpage();
		...
		<style>
			.nav-tabs>li>a { padding-right: 6px; padding-left: 6px; } .radio.inline+.radio.inline,
	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				"); %>" />
				<input type="hidden" name="url_num_x_0" value="<% nvram_get_x(" ","url_num_x
				"); %>" readonly="1">
										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#FirewallConfig_UrlFilterEnable_sectiondesc#>
												</div>
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td style="padding-bottom: 0px; border-top: 0 none;">
															<input type="checkbox" id="url_enable_fake" <% nvram_match_x( "",
															"url_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "url_enable_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="url_enable_x" id="url_enable_1" onClick="change_url_enable();"
																	<% nvram_match_x( "", "url_enable_x", "1", "checked"); %>
																	>
																	<#CTL_Enabled#>
																		<input type="radio" value="0" name="url_enable_x" id="url_enable_0" onClick="change_url_enable();"
																		<% nvram_match_x( "", "url_enable_x", "0", "checked"); %>
																		>
																		<#CTL_Disabled#>
																</div>
														</td>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_urlf_main"
												style="display:none">
													<tr>
													...
													<tr>
														<th width="50%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,9,1);">
																<#FirewallConfig_URLActiveDate_itemname#>
															</a>
														</th>
														<td colspan="2">
															<div class="controls">
																<label class="checkbox inline">
																	<input type="checkbox" name="url_date_x_Mon" class="input" onChange="return changeDate();">
																	<#DAY_Mon#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="url_date_x_Tue" class="input" onChange="return changeDate();">
																	<#DAY_Tue#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="url_date_x_Wed" class="input" onChange="return changeDate();">
																	<#DAY_Wed#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="url_date_x_Thu" class="input" onChange="return changeDate();">
																	<#DAY_Thu#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="url_date_x_Fri" class="input" onChange="return changeDate();">
																	<#DAY_Fri#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="url_date_x_Sat" class="input" onChange="return changeDate();">
																	<#DAY_Sat#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" name="url_date_x_Sun" class="input" onChange="return changeDate();">
																	<#DAY_Sun#>
																</label>
															</div>
														</td>
													...
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,9,2);">
																<#FirewallConfig_URLActiveTime_itemname#>
																	:
															</a>
														</th>
														<td colspan="2">
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="url_time_x_starthour" onKeyPress="return is_number(this,event);">
															:
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="url_time_x_startmin" onKeyPress="return is_number(this,event);">
															-
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="url_time_x_endhour" onKeyPress="return is_number(this,event);">
															:
															<input type="text" maxlength="2" class="input" style="width: 25px;" size="2"
															name="url_time_x_endmin" onKeyPress="return is_number(this,event);">
														</td>
													</tr>
													<tr>
														<th>
															<#FirewallConfig_UrlMAC#>
																:
														</th>
														<td colspan="2" align="left">
															...
															<div class="input-append">
																<input type="text" maxlength="12" class="span12" size="15" name="url_mac_x"
																value="<% nvram_get_x(" ","url_mac_x "); %>" onKeyPress="return is_hwaddr(event);"
																style="float:left; width: 162px">
																...
																&nbsp;
																<label class="checkbox inline">
																	<input type="checkbox" name="url_inv_fake" value="" onclick="click_mac_inv(this);"
																	<% nvram_match_x( "", "url_inv_x", "1", "checked"); %>
																	/>
																	<#FirewallConfig_UrlInv#>
																</label>
															</div>
														</td>
													</tr>
													<tr>
														<th>
															<#FirewallConfig_UrlList_groupitemdesc#>
														</th>
														<td style="padding-right: 0px;">
															<input type="text" class="span12" maxlength="96" size="36" name="url_keyword_x_0"
															value="<% nvram_get_x(" ", "url_keyword_x_0 "); %>" onKeyPress="return is_string(this,event);">
														</td>
														<td align="left">
															<button class="btn" type="submit" onClick="if(validForm()){return markGroup(this, 'UrlList', 128, ' Add ');}"
															name="UrlList">
													...
													<tr>
														...
														<td style="vertical-align:top">
															<button class="btn btn-danger" type="submit" onClick="return markGroup(this, 'UrlList', 128, ' Del ');"
															name="UrlList">
																<i class="if if-btn-minus">
																</i>
															</button>
														</td>
													</tr>
