										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#IPConnection_VServerEnable_sectiondesc#>
												</div>
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="upnp_enable_x_fake" <% nvram_match_x( "",
															"upnp_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "upnp_enable_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="upnp_enable_x" id="upnp_enable_x_1"
																	onclick="change_upnp_enabled();" <% nvram_match_x( "", "upnp_enable_x",
																	"1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="upnp_enable_x" id="upnp_enable_x_0"
																		onclick="change_upnp_enabled();" <% nvram_match_x( "", "upnp_enable_x",
																		"0", "checked"); %>
																		/>
																		<#checkbox_No#>
													...
													<tr id="row_upnp_proto">
														...
														<td>
															<select name="upnp_proto" class="input">
																<option value="0" <% nvram_match_x( "", "upnp_proto", "0", "selected");
																%>
																	>UPnP (*)
																</option>
																<option value="1" <% nvram_match_x( "", "upnp_proto", "1", "selected");
																%>
																	>NAT-PMP & PCP
																</option>
																<option value="2" <% nvram_match_x( "", "upnp_proto", "2", "selected");
																%>
																	>UPnP & NAT-PMP & PCP
																</option>
															</select>
													...
													<tr id="row_upnp_secure">
														...
														<td>
															<select name="upnp_secure" class="input">
																<option value="0" <% nvram_match_x( "", "upnp_secure", "0", "selected");
																%>
																	>
																	<#checkbox_No#>
																</option>
																<option value="1" <% nvram_match_x( "", "upnp_secure", "1", "selected");
																%>
																	>
																	<#checkbox_Yes#>
																		(*)
													...
													<tr id="row_upnp_eports">
														...
														<td>
															...
															name="upnp_eport_min" value="<% nvram_get_x(" ", "upnp_eport_min
															"); %>" onkeypress="return is_number(this,event);" />
															&nbsp;-
															<input type="text" maxlength="5" class="input" size="10" style="width: 94px;"
															name="upnp_eport_max" value="<% nvram_get_x(" ", "upnp_eport_max
															"); %>" onkeypress="return is_number(this,event);" />
															&nbsp;
													...
													<tr id="row_upnp_iports">
														...
														<td>
															<input type="text" maxlength="5" class="input" size="10" style="width: 94px;"
															name="upnp_iport_min" value="<% nvram_get_x(" ", "upnp_iport_min
															"); %>" onkeypress="return is_number(this,event);" />
															&nbsp;-
															<input type="text" maxlength="5" class="input" size="10" style="width: 94px;"
															name="upnp_iport_max" value="<% nvram_get_x(" ", "upnp_iport_max
															"); %>" onkeypress="return is_number(this,event);" />
															&nbsp;
															<span style="color:#888;">
																[1..65535]
													...
													<tr id="row_upnp_clean_int">
														...
														<td>
															<input type="text" maxlength="5" class="input" size="32" name="upnp_clean_int"
															value="<% nvram_get_x(" ", "upnp_clean_int "); %>" onkeypress="return is_number(this,event);"
															/>
															&nbsp;
															<span style="color:#888;">
																[0..86400]
													...
													<tr id="row_upnp_clean_min">
														...
														<td>
															<input type="text" maxlength="3" class="input" size="32" name="upnp_clean_min"
															value="<% nvram_get_x(" ", "upnp_clean_min "); %>" onkeypress="return is_number(this,event);"
															/>
															&nbsp;
															<span style="color:#888;">
																[1..999]
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														<th width="50%">
															<#IPConnection_VServerEnable_itemname#>
																<input type="hidden" name="vts_num_x_0" value="<% nvram_get_x(" IPConnection
																", "vts_num_x "); %>" readonly="1" />
														</th>
														<td>
															<input type="checkbox" id="vts_enable_x_fake" <% nvram_match_x( "",
															"vts_enable_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "vts_enable_x", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="vts_enable_x" id="vts_enable_x_1"
																	onclick="change_vts_enabled();" <% nvram_match_x( "", "vts_enable_x",
																	"1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="vts_enable_x" id="vts_enable_x_0"
																		onclick="change_vts_enabled();" <% nvram_match_x( "", "vts_enable_x",
																		"0", "checked"); %>
																		/>
																		<#checkbox_No#>
													...
													<tr id="row_famous_apps">
														<th>
															<#IPConnection_VSList_groupitemdesc#>
														</th>
														<td id="VSList">
															<select name="KnownApps" id="KnownApps" class="input" onchange="change_wizard(this, 'KnownApps');">
															</select>
														</td>
													</tr>
													<tr id="row_famous_game">
														<th>
															<#IPConnection_VSList_gameitemdesc#>
														</th>
														<td id="VSGameList">
															<select name="KnownGames" id="KnownGames" class="input" onchange="change_wizard(this, 'KnownGames');">
															</select>
														</td>
													</tr>
												</table>
												...
												id="VSList_Block">
													<tr>
														<th colspan="7" style="background-color: #E3E3E3;">
															<#IPConnection_VSList_title#>
														</th>
													</tr>
													<tr>
														<td>
															<#IPConnection_VServerDescript_itemname#>
														</td>
														<td width="18%">
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,3);">
																<#IPConnection_VServerSrcIP_itemname#>
															</a>
														</td>
														<td width="15%" id="col_port_proto">
															<#IPConnection_VServerPort_itemname#>
														</td>
														<td width="22%">
															<#IPConnection_VServerIP_itemname#>
														</td>
														<td width="10%">
															<#IPConnection_VServerLPort_itemname#>
														</td>
														<td width="11%">
															<#IPConnection_VServerProto_itemname#>
														</td>
														<td width="5%">
															&nbsp;
														</td>
													...
													<tr>
														<td>
															<input type="text" size="10" class="span12" maxlength="30" name="vts_desc_x_0"
															value="<% nvram_get_x(" ", "vts_desc_x_0 "); %>" onkeypress="return is_string(this,event);"
															/>
														</td>
														<td>
															<input type="text" size="12" class="span12" maxlength="15" name="vts_srcip_x_0"
															value="<% nvram_get_x(" ", "vts_srcip_x_0 "); %>" onKeyPress="return is_iprange(this,event);"
															/>
														</td>
														<td>
															<input type="text" size="10" class="span12" name="vts_port_x_0" value="<% nvram_get_x("
															", "vts_port_x_0 "); %>" onkeypress="return is_portrange(this,event);" />
															<input style="display:none" type="text" class="span12" maxlength="3" size="3"
															name="vts_protono_x_0" value="<% nvram_get_x(" ", "vts_protono_x_0
															"); %>" onkeypress="return is_number(this,event);" />
														</td>
														<td>
															<div id="ClientList_Block" class="alert alert-info ddown-list">
															</div>
															<div class="input-append">
																<input type="text" size="12" maxlength="15" name="vts_ipaddr_x_0" value="<% nvram_get_x("
																", "vts_ipaddr_x_0 "); %>" onkeypress="return is_ipaddr(this,event);" style="float:left; width: 94px"
																/>
																<button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);"
																title="Select the IP of LAN clients.">
														...
														<td>
															<input type="text" size="5" class="span12" maxlength="5" name="vts_lport_x_0"
															value="<% nvram_get_x(" ", "vts_lport_x_0 "); %>" onkeypress="return is_number(this,event);"
															/>
														</td>
														<td>
															<select name="vts_proto_x_0" class="span12" onchange="change_proto()">
																<option value="TCP" <% nvram_match_x( "", "vts_proto_x_0", "TCP",
																"selected"); %>
																	>TCP
																</option>
																<option value="UDP" <% nvram_match_x( "", "vts_proto_x_0", "UDP",
																"selected"); %>
																	>UDP
																</option>
																<option value="BOTH" <% nvram_match_x( "", "vts_proto_x_0", "BOTH",
																"selected"); %>
																	>Both
																</option>
																<option value="OTHER" <% nvram_match_x( "", "vts_proto_x_0", "OTHER",
																"selected"); %>
																	>Other
																</option>
															</select>
														...
														<td>
															<button class="btn" type="submit" onclick="return markGroupVS(this, 64, ' Add ');"
															name="VSList2">
