...
$j(document).ready(function() {
    ...
    init_itoggle('rt_guest_macrule');
		...
		<script>
			function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-2gwifi', 2);
    show_footer();
...
function validForm() {
    ...
    if (!validate_timerange(document.form.rt_guest_time_x_starthour, 0) || !validate_timerange(document.form.rt_guest_time_x_startmin, 1) || !validate_timerange(document.form.rt_guest_time_x_endhour, 2) || !validate_timerange(document.form.rt_guest_time_x_endmin, 3))
        return false;
    ...
    if (!validate_timerange(document.form.rt_guest_time2_x_starthour, 0) || !validate_timerange(document.form.rt_guest_time2_x_startmin, 1) || !validate_timerange(document.form.rt_guest_time2_x_endhour, 2) || !validate_timerange(document.form.rt_guest_time2_x_endmin, 3))
        return false;
	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			<form method="post" name="form" action="/start_apply.htm" target="hidden_frame">
				...
				"); %>" readonly="1">
				<input type="hidden" name="rt_country_code" value="<% nvram_get_x("
				","rt_country_code "); %>">
				<input type="hidden" name="rt_guest_ssid_org" value="<% nvram_char_to_ascii("
				", "rt_guest_ssid "); %>">
				<input type="hidden" name="rt_guest_wpa_mode" value="<% nvram_get_x("
				","rt_guest_wpa_mode "); %>">
				<input type="hidden" name="rt_guest_wpa_psk_org" value="<% nvram_char_to_ascii("
				", "rt_guest_wpa_psk "); %>">
				<input type="hidden" name="rt_guest_date_x" value="<% nvram_get_x("
				","rt_guest_date_x "); %>">
				<input type="hidden" name="rt_guest_time_x" value="<% nvram_get_x("
				","rt_guest_time_x "); %>">
				<input type="hidden" name="rt_guest_time2_x" value="<% nvram_get_x("
				","rt_guest_time2_x "); %>">
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td style="border-top: 0 none;">
															<input type="checkbox" id="rt_guest_enable_fake" <% nvram_match_x( "",
															"rt_guest_enable", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "rt_guest_enable", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" id="rt_guest_enable_1" name="rt_guest_enable"
																	class="input" onClick="change_guest_enabled(1);" <% nvram_match_x( "",
																	"rt_guest_enable", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" id="rt_guest_enable_0" name="rt_guest_enable"
																		class="input" onClick="change_guest_enabled(1);" <% nvram_match_x( "",
																		"rt_guest_enable", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
														...
														<td>
															<div class="controls">
																<label class="checkbox inline">
																	<input type="checkbox" class="input" name="rt_guest_date_x_Mon" onChange="return changeDate();"
																	/>
																	<#DAY_Mon#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" class="input" name="rt_guest_date_x_Tue" onChange="return changeDate();"
																	/>
																	<#DAY_Tue#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" class="input" name="rt_guest_date_x_Wed" onChange="return changeDate();"
																	/>
																	<#DAY_Wed#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" class="input" name="rt_guest_date_x_Thu" onChange="return changeDate();"
																	/>
																	<#DAY_Thu#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" class="input" name="rt_guest_date_x_Fri" onChange="return changeDate();"
																	/>
																	<#DAY_Fri#>
																</label>
															</div>
													...
													<tr id="row_guest_2" style="display:none;">
														...
														<td style="border-top: 0 none;">
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time_x_starthour"
															onKeyPress="return is_number(this,event);">
															:
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time_x_startmin"
															onKeyPress="return is_number(this,event);">
															&nbsp;-&nbsp;
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time_x_endhour"
															onKeyPress="return is_number(this,event);">
															:
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time_x_endmin"
															onKeyPress="return is_number(this,event);">
														</td>
													</tr>
													<tr id="row_guest_3" style="display:none;">
														...
														<td>
															<div class="controls">
																<label class="checkbox inline">
																	<input type="checkbox" class="input" name="rt_guest_date_x_Sat" onChange="return changeDate();"
																	/>
																	<#DAY_Sat#>
																</label>
																<label class="checkbox inline">
																	<input type="checkbox" class="input" name="rt_guest_date_x_Sun" onChange="return changeDate();"
																	/>
																	<#DAY_Sun#>
																</label>
															</div>
													...
													<tr id="row_guest_4" style="display:none;">
														...
														<td style="border-top: 0 none;">
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time2_x_starthour"
															onKeyPress="return is_number(this,event);">
															:
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time2_x_startmin"
															onKeyPress="return is_number(this,event);">
															&nbsp;-&nbsp;
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time2_x_endhour"
															onKeyPress="return is_number(this,event);">
															:
															<input type="text" maxlength="2" style="width: 20px;" size="2" name="rt_guest_time2_x_endmin"
															onKeyPress="return is_number(this,event);">
														</td>
													</tr>
													<tr id="row_guest_5" style="display:none;">
														...
														<td>
															<input type="text" maxlength="32" class="input" size="32" name="rt_guest_ssid"
													...
													<tr id="row_guest_6" style="display:none;">
														...
														<td>
															<input type="checkbox" id="rt_guest_closed_fake" <% nvram_match_x( "",
															"rt_guest_closed", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "rt_guest_closed", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" id="rt_guest_closed_1" name="rt_guest_closed"
																	class="input" <% nvram_match_x( "", "rt_guest_closed", "1", "checked");
																	%>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" id="rt_guest_closed_0" name="rt_guest_closed"
																		class="input" <% nvram_match_x( "", "rt_guest_closed", "0", "checked");
																		%>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<tr id="row_guest_7" style="display:none;">
														...
														<td>
															<input type="checkbox" id="rt_guest_lan_isolate_fake" <% nvram_match_x(
															"", "rt_guest_lan_isolate", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "rt_guest_lan_isolate", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" id="rt_guest_lan_isolate_1" name="rt_guest_lan_isolate"
																	class="input" <% nvram_match_x( "", "rt_guest_lan_isolate", "1",
																	"checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" id="rt_guest_lan_isolate_0" name="rt_guest_lan_isolate"
																		class="input" <% nvram_match_x( "", "rt_guest_lan_isolate", "0",
																		"checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<tr id="row_guest_8" style="display:none;">
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this, 3, 5);">
																<#WLANConfig11b_x_IsolateAP_itemname#>
															</a>
														</th>
														<td>
															<input type="checkbox" id="rt_guest_ap_isolate_fake" <% nvram_match_x(
															"", "rt_guest_ap_isolate", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "rt_guest_ap_isolate", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" id="rt_guest_ap_isolate_1" name="rt_guest_ap_isolate"
																	class="input" <% nvram_match_x( "", "rt_guest_ap_isolate", "1",
																	"checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" id="rt_guest_ap_isolate_0" name="rt_guest_ap_isolate"
																		class="input" <% nvram_match_x( "", "rt_guest_ap_isolate", "0",
																		"checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<tr id="row_guest_9" style="display:none;">
														...
														<td>
															<select name="rt_guest_mcs_mode" class="input">
																<option value="0" <% nvram_match_x( "", "rt_guest_mcs_mode", "0",
																"selected"); %>
																	>
																	<#checkbox_No#>
																		(*)
																</option>
																<option value="1" <% nvram_match_x( "", "rt_guest_mcs_mode", "1",
																"selected"); %>
																	>HTMIX (1S) 45 Mbps
																</option>
																<option value="2" <% nvram_match_x( "", "rt_guest_mcs_mode", "2",
																"selected"); %>
																	>HTMIX (1S) 30 Mbps
																</option>
																<option value="3" <% nvram_match_x( "", "rt_guest_mcs_mode", "3",
																"selected"); %>
																	>HTMIX (1S) 15 Mbps
																</option>
																<option value="4" <% nvram_match_x( "", "rt_guest_mcs_mode", "4",
																"selected"); %>
																	>OFDM 12 Mbps
																</option>
																<option value="5" <% nvram_match_x( "", "rt_guest_mcs_mode", "5",
																"selected"); %>
																	>OFDM 9 Mbps
																</option>
																<option value="6" <% nvram_match_x( "", "rt_guest_mcs_mode", "6",
																"selected"); %>
																	>OFDM 6 Mbps
																</option>
																<option value="7" <% nvram_match_x( "", "rt_guest_mcs_mode", "7",
																"selected"); %>
																	>CCK 5.5 Mbps
																</option>
																<option value="8" <% nvram_match_x( "", "rt_guest_mcs_mode", "8",
																"selected"); %>
																	>CCK 2 Mbps
																</option>
																<option value="9" <% nvram_match_x( "", "rt_guest_mcs_mode", "9",
																"selected"); %>
																	>CCK 1 Mbps
																</option>
															</select>
													...
													<tr id="row_guest_10" style="display:none;">
														...
														<td>
															<select name="rt_guest_auth_mode" class="input" onChange="change_guest_auth_mode(1);">
																<option value="open" <% nvram_match_x( "", "rt_guest_auth_mode",
																"open", "selected"); %>
																	>Open System
																</option>
																<option value="psk" <% nvram_double_match_x( "", "rt_guest_auth_mode",
																"psk", "", "rt_guest_wpa_mode", "1", "selected"); %>
																	>WPA-Personal
																</option>
																<option value="psk" <% nvram_double_match_x( "", "rt_guest_auth_mode",
																"psk", "", "rt_guest_wpa_mode", "2", "selected"); %>
																	>WPA2-Personal
																</option>
																<option value="psk" <% nvram_double_match_x( "", "rt_guest_auth_mode",
																"psk", "", "rt_guest_wpa_mode", "0", "selected"); %>
																	>WPA-Auto-Personal
																</option>
															</select>
														</td>
													...
													<tr id="row_guest_11" style="display:none;">
														...
														<td>
															<select name="rt_guest_crypto" class="input">
																<option value="tkip" <% nvram_match_x( "", "rt_guest_crypto", "tkip",
																"selected"); %>
																	>TKIP
																</option>
																<option value="aes" <% nvram_match_x( "", "rt_guest_crypto", "aes",
																"selected"); %>
																	>AES
																</option>
																<option value="tkip+aes" <% nvram_match_x( "", "rt_guest_crypto",
																"tkip+aes", "selected"); %>
																	>TKIP+AES
																</option>
															</select>
													...
													<tr id="row_guest_12" style="display:none;">
														...
														<td>
															<div class="input-append">
																<input type="password" name="rt_guest_wpa_psk" id="rt_guest_wpa_psk" maxlength="64"
																size="32" value="" style="width: 175px;">
																<button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('rt_guest_wpa_psk')">
													...
													<tr id="row_guest_13" style="display:none;">
														...
														<td>
															<input type="checkbox" id="rt_guest_macrule_fake" <% nvram_match_x( "",
															"rt_guest_macrule", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "rt_guest_macrule", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" id="rt_guest_macrule_1" name="rt_guest_macrule"
																	class="input" <% nvram_match_x( "", "rt_guest_macrule", "1", "checked");
																	%>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" id="rt_guest_macrule_0" name="rt_guest_macrule"
																		class="input" <% nvram_match_x( "", "rt_guest_macrule", "0", "checked");
																		%>
																		/>
																		<#checkbox_No#>
																</div>
												...
												<table class="table">
													<tr>
														<td id="col_goto5" width="50%" style="margin-top: 10px; border-top: 0 none;">
															...
															onclick="location.href='Advanced_WGuest_Content.asp';">
														</td>
														<td style="border-top: 0 none;">
