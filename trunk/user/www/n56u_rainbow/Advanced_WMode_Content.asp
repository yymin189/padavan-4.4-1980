	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				"); %>">
				<input type="hidden" name="wl_wdsnum_x_0" value="<% nvram_get_x(" ", "wl_wdsnum_x
				"); %>" readonly="1">
				<input type="hidden" name="wl_sta_auto" value="<% nvram_get_x(" ", "wl_sta_auto
				"); %>" />
				<input type="hidden" name="wl_sta_ssid_org" value="<% nvram_char_to_ascii("
				", "wl_sta_ssid "); %>">
				<input type="hidden" name="wl_sta_wpa_mode" value="<% nvram_get_x("
				","wl_sta_wpa_mode "); %>">
				<input type="hidden" name="wl_sta_wpa_psk_org" value="<% nvram_char_to_ascii("
				", "wl_sta_wpa_psk "); %>">
													...
													<tr>
														...
														<td style="border-top: 0 none;">
															<select name="wl_mode_x" class="input" onChange="change_wireless_bridge();">
																<option value="0" <% nvram_match_x( "", "wl_mode_x", "0", "selected");
																%>
																	>
																	<#WdsMode0#>
																</option>
																                    
																<option value="1" <% nvram_match_x( "", "wl_mode_x", "1", "selected");
																%>
																	>
																	<#WdsMode1#>
																</option>
																                    
																<option value="2" <% nvram_match_x( "", "wl_mode_x", "2", "selected");
																%>
																	>
																	<#WdsMode2#>
																</option>
																                    
																<option value="3" <% nvram_match_x( "", "wl_mode_x", "3", "selected");
																%>
																	>
																	<#WdsMode3#>
																</option>
																                    
																<option value="4" <% nvram_match_x( "", "wl_mode_x", "4", "selected");
																%>
																	>
																	<#WdsMode4#>
																</option>
													...
													<tr id="row_apc_wisp" style="display:none;">
														...
														<td>
															<select name="wl_sta_wisp" class="input">
																<option value="0" <% nvram_match_x( "", "wl_sta_wisp", "0", "selected");
																%>
																	>LAN bridge
																</option>
																<option value="1" <% nvram_match_x( "", "wl_sta_wisp", "1", "selected");
																%>
																	>WAN (Wireless ISP)
																</option>
															</select>
													...
													<tr id="row_channel" style="display:none;">
														...
														<td>
															...
															<label id="auto_seek" class="checkbox inline">
																...
																onclick="click_auto_seek(this);" <% nvram_match_x( "", "wl_sta_auto",
																"1", "checked"); %>
																/>
																<#APCliAuto#>
															</label>
													...
													<tr id="row_wds_1" style="display:none;">
														...
														<td>
															<select name="wl_wdsapply_x" class="input" onChange="change_wdsapply();">
																<option value="0" <% nvram_match_x( "", "wl_wdsapply_x", "0",
																"selected"); %>
																	>
																	<#WdsLazy#>
																</option>
																                    
																<option value="1" <% nvram_match_x( "", "wl_wdsapply_x", "1",
																"selected"); %>
																	>
																	<#checkbox_Yes#>
																</option>
													...
													<tr id="row_wds_apc" style="display:none;">
														...
														<td>
															...
															<div class="input-append" style="float: left;">
																<input type="text" id="ctl_wds_1" name="wl_wdslist_x_0" maxlength="12"
																size="14" onKeyPress="return is_hwaddr(event);" style="float:left; width: 175px;">
																<input type="text" id="ctl_apc_2" name="wl_sta_ssid" value="" maxlength="32"
															...
															type="submit" onClick="return markGroup(this, 'RBRList', 4, ' Add ');"
															name="RBRList" value="<#CTL_add#>" size="12">
													...
													<tr id="row_wds_2" style="display:none;">
														...
														<td>
															<div style="float: left;">
																...
																<input class="btn btn-danger" style="width: 99px;" type="submit" onClick="return markGroup(this, 'RBRList', 2, ' Del ');"
																name="RBRList2" value="<#CTL_del#>" size="12">
															</div>
														</td>
													</tr>
													<tr id="row_apc_1" style="display:none;">
														...
														<td>
															<select name="wl_sta_auth_mode" class="input" onChange="change_sta_auth_mode(1);">
																<option value="open" <% nvram_match_x( "", "wl_sta_auth_mode", "open",
																"selected"); %>
																	>Open System
																</option>
																<option value="psk" <% nvram_double_match_x( "", "wl_sta_auth_mode",
																"psk", "", "wl_sta_wpa_mode", "1", "selected"); %>
																	>WPA-Personal
																</option>
																<option value="psk" <% nvram_double_match_x( "", "wl_sta_auth_mode",
																"psk", "", "wl_sta_wpa_mode", "2", "selected"); %>
																	>WPA2-Personal
																</option>
															</select>
														</td>
													...
													<tr id="row_apc_2" style="display:none;">
														...
														<td>
															<select name="wl_sta_crypto" class="input">
																<option value="tkip" <% nvram_match_x( "", "wl_sta_crypto", "tkip",
																"selected"); %>
																	>TKIP
																</option>
																<option value="aes" <% nvram_match_x( "", "wl_sta_crypto", "aes",
																"selected"); %>
																	>AES
																</option>
															</select>
													...
													<tr id="row_apc_3" style="display:none;">
														...
														<td>
															<div class="input-append">
																<input type="password" name="wl_sta_wpa_psk" id="wl_sta_wpa_psk" maxlength="64"
																size="32" value="" style="width: 175px;">
																<button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('wl_sta_wpa_psk')">
