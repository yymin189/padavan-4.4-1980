										...
										<div class="round_bottom">
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<#WLANAuthentication11a_display1_sectiondesc#>
												</div>
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td width="50%" style="border-top: 0 none;">
															<input type="text" maxlength="15" class="input" size="15" name="rt_radius_ipaddr"
															value="<% nvram_get_x(" ","rt_radius_ipaddr "); %>" onKeyPress="return is_ipaddr(this,event);"
															/>
														</td>
													</tr>
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,2,2);">
																<#WLANAuthentication11a_ExAuthDBPortNumber_itemname#>
															</a>
														</th>
														<td>
															<input type="text" maxlength="5" class="input" size="5" name="rt_radius_port"
															value="<% nvram_get_x(" ","rt_radius_port "); %>" onkeypress="return is_number(this,event);"
															onblur="return validate_portrange(this, '');" />
														</td>
													</tr>
													<tr>
														<th>
															<a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,2,3);">
																<#WLANAuthentication11a_ExAuthDBPassword_itemname#>
															</a>
														</th>
														<td>
															<div class="input-append">
																<input type="password" name="rt_radius_key" id="rt_radius_key" maxlength="64"
																size="32" style="width: 175px;" value="<% nvram_get_x(" ","rt_radius_key
																"); %>" />
																<button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('rt_radius_key')">
												...
												<table class="table">
													<tr>
														<td id="col_goto5" width="50%" style="margin-top: 10px; border-top: 0 none;">
															...
															onclick="location.href='Advanced_WSecurity_Content.asp';">
														</td>
