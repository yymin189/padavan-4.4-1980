...
function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-5gwifi', 5);
    show_footer();
}
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td width="50%" style="border-top: 0 none;">
															<input type="text" maxlength="15" class="input" size="15" name="wl_radius_ipaddr"
															value="<% nvram_get_x(" ","wl_radius_ipaddr "); %>" onKeyPress="return is_ipaddr(this,event);"
															/>
														</td>
													</tr>
													<tr>
														...
														<td>
															<input type="text" maxlength="5" class="input" size="5" name="wl_radius_port"
															value="<% nvram_get_x(" ","wl_radius_port "); %>" onkeypress="return is_number(this,event);"
													...
													<tr>
														...
														<td>
															<div class="input-append">
																<input type="password" name="wl_radius_key" id="wl_radius_key" maxlength="64"
																size="32" style="width: 175px;" value="<% nvram_get_x(" ","wl_radius_key
																"); %>"/>
																<button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('wl_radius_key')">
