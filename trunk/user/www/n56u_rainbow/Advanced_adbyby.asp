...
function initial() {
    show_banner(2);
    show_menu('if-m1-syssettings', 'if-m2-adguard');
    show_footer();
...
function showMDHCPList() {
    ...
    if (m_dhcp.length == 0)
        ...
        code += '<td><button class="btn btn-danger" type="submit" onclick="markGroupMDHCP(this, 64, \' Del \');" name="AdIPList"><i class="if if-btn-minus"></i></button></td>';
        code += '</tr>';
    }
    code += '</table>';
...
function showMRULESList() {
    ...
    if (m_rules.length == 0)
        ...
        code += '<td><button class="btn btn-danger" type="submit" onclick="markGroupRULES(this, 64, \' Del \');" name="AdRULESList"><i class="if if-btn-minus"></i></button></td>';
        code += '</tr>';
    }
    code += '</table>';
	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="adbybyip_staticnum_x_0" value="<% nvram_get_x("
				AdIPList ", "adbybyip_staticnum_x "); %>" readonly="1" />
				<input type="hidden" name="adbybyrules_staticnum_x_0" value="<% nvram_get_x("
				AdRULESList ", "adbybyrules_staticnum_x "); %>" readonly="1" />
										...
										<div class="round_bottom">
											<div>
												<ul class="nav nav-tabs" style="margin-bottom: 10px;">
													<li class="active">
														<a href="Advanced_adbyby.asp">
															<#menu5_20_1#>
														</a>
													</li>
													<li id="adlink" style="display:none">
														<a href="Advanced_koolproxy.asp">
															<#menu5_26_1#>
														</a>
													</li>
												</ul>
											...
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													...
													<div>
														anti-AD项目地址:
														<a href="https://github.com/privacy-protection-tools/anti-AD">
															https://github.com/privacy-protection-tools/anti-AD
														</a>
													</div>
													<div>
														静态规则：【
														<% nvram_get_x( "", "adbyby_ltime"); %>
															】 | 视频规则：【
															<% nvram_get_x( "", "adbyby_vtime"); %>
																】
													</div>
													<div>
														anti-AD规则：【
														<% nvram_get_x( "", "anti_ad_count"); %>
															】条 | Hosts AD：【
															<% nvram_get_x( "", "adbyby_hostsad"); %>
																】条
													</div>
													<div>
														第三方规则：【
														<% nvram_get_x( "", "adbyby_user"); %>
															】条
													</div>
													<div>
													</div>
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="adbyby_enable_fake" <% nvram_match_x( "",
															"adbyby_enable", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "adbyby_enable", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="adbyby_enable" id="adbyby_enable_1"
																	class="input" <% nvram_match_x( "", "adbyby_enable", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="adbyby_enable" id="adbyby_enable_0"
																		class="input" <% nvram_match_x( "", "adbyby_enable", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr>
														...
														<td>
															<select name="adbyby_set" class="input">
																<option value="0" <% nvram_match_x( "", "adbyby_set", "0", "selected");
																%>
																	>全局模式，过滤效果最强，但可能造成网络卡顿
																</option>
																<option value="1" <% nvram_match_x( "", "adbyby_set", "1", "selected");
																%>
																	>Plus + 模式(只过滤列表内域名结合ABP名单,推荐)
																</option>
																<option value="2" <% nvram_match_x( "", "adbyby_set", "2", "selected");
																%>
																	>内网IP列表控制模式
																</option>
															</select>
													...
													<tr id="adbyby_update_tr">
														...
														<td>
															<select name="adbyby_update" class="input" style="width: 60px;">
																<option value="0" <% nvram_match_x( "", "adbyby_update", "0",
																"selected"); %>
																	>每天
																</option>
																<option value="1" <% nvram_match_x( "", "adbyby_update", "1",
																"selected"); %>
																	>每隔
																</option>
																<option value="2" <% nvram_match_x( "", "adbyby_update", "2",
																"selected"); %>
																	>关闭
																</option>
															</select>
															<select name="adbyby_update_hour" id="adbyby_update_hour" class="input"
															style="width: 50px">
															</select>
															时
															<select name="adbyby_update_min" id="adbyby_update_min" class="input"
															style="width: 50px">
															</select>
															分
														</td>
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="block_ios_fake" <% nvram_match_x( "",
															"block_ios", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "block_ios", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="block_ios" id="block_ios_1" class="input"
																	value="1" <% nvram_match_x( "", "block_ios", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="block_ios" id="block_ios_0" class="input"
																		value="0" <% nvram_match_x( "", "block_ios", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="block_douyin_fake" <% nvram_match_x( "",
															"block_douyin", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "block_douyin", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="block_douyin" id="block_douyin_1"
																	class="input" value="1" <% nvram_match_x( "", "block_douyin", "1",
																	"checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="block_douyin" id="block_douyin_0"
																		class="input" value="0" <% nvram_match_x( "", "block_douyin", "0",
																		"checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<tr>
														<th width="50%">
															<a class="help_tooltip" href="javascript: void(0)" onmouseover="openTooltip(this, 2, 1);">
																加载anti-AD项目规则:
															</a>
														</th>
														<td>
															<input type="checkbox" id="anti_ad_fake" <% nvram_match_x( "",
															"anti_ad", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "anti_ad", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="anti_ad" id="anti_ad_1" class="input"
																	value="1" <% nvram_match_x( "", "anti_ad", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="anti_ad" id="anti_ad_0" class="input"
																		value="0" <% nvram_match_x( "", "anti_ad", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr>
														...
														<td>
															<input type="text" class="input" size="60" name="anti_ad_link" value="<% nvram_get_x("
															","anti_ad_link "); %>" />
														</td>
													</tr>
													<tr>
														...
														<td>
															<input type="checkbox" id="hosts_ad_fake" <% nvram_match_x( "",
															"hosts_ad", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "hosts_ad", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="hosts_ad" id="hosts_ad_1" class="input"
																	value="1" <% nvram_match_x( "", "hosts_ad", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="hosts_ad" id="hosts_ad_0" class="input"
																		value="0" <% nvram_match_x( "", "hosts_ad", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr>
														<td colspan="3">
															...
															<div id="script15">
																...
																name="scripts.adbyby_host.sh" style="font-family:'Courier New'; font-size:12px;">
																	<% nvram_dump( "scripts.adbyby_host.sh", ""); %>
																</textarea>
															</div>
														</td>
													</tr>
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th colspan="5" id="GWStatic" style="background-color: #E3E3E3;">
															自定义IP过滤设置
														</th>
													</tr>
													<tr>
														...
														<td colspan="2" width="50%">
															<input type="checkbox" id="adbyby_ip_x_fake" <% nvram_match_x( "",
															"adbyby_ip_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "adbyby_ip_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="adbyby_ip_x" id="adbyby_ip_x_1" onclick="change_adbyby_ip_enabled()"
																	<% nvram_match_x( "", "adbyby_ip_x", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="adbyby_ip_x" id="adbyby_ip_x_0" onclick="change_adbyby_ip_enabled()"
																		<% nvram_match_x( "", "adbyby_ip_x", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr id="row_static_header" style="display:none">
														<td width="25%">
															...
															<div class="input-append">
																<input type="text" maxlength="12" class="span12" size="12" name="adbybyip_mac_x_0"
																value="<% nvram_get_x(" ", "adbybyip_mac_x_0 "); %>" onkeypress="return is_hwaddr(event);"
														...
														<td width="25%">
															<input type="text" maxlength="15" class="span12" size="15" name="adbybyip_ip_x_0"
															value="<% nvram_get_x(" ", "adbybyip_ip_x_0 "); %>" onkeypress="return is_ipaddr(this,event);"
															/>
														</td>
														<td width="25%">
															<input type="text" maxlength="24" class="span12" size="20" name="adbybyip_name_x_0"
															value="<% nvram_get_x(" ", "adbybyip_name_x_0 "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
														<td width="20%">
															<select name="adbybyip_ip_road_x_0" class="input" style="width: 110px">
																<option value="0" <% nvram_match_x( "", "adbybyip_ip_road_x_0", "0",
																"selected"); %>
																	>直连模式
																</option>
																<option value="1" <% nvram_match_x( "", "adbybyip_ip_road_x_0", "1",
																"selected"); %>
																	>全局模式
																</option>
																<option value="2" <% nvram_match_x( "", "adbybyip_ip_road_x_0", "2",
																"selected"); %>
																	>plus+模式
																</option>
															</select>
												...
												<table width="100%" align="center" cellpadding="5" cellspacing="0" class="table">
													...
													<tr>
														...
														<td width="50%">
															<input type="checkbox" id="adbyby_rules_x_fake" <% nvram_match_x( "",
															"adbyby_rules_x", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "adbyby_rules_x", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="adbyby_rules_x" id="adbyby_rules_x_1"
																	onclick="change_adbyby_rules_enabled()" <% nvram_match_x( "",
																	"adbyby_rules_x", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="adbyby_rules_x" id="adbyby_rules_x_0"
																		onclick="change_adbyby_rules_enabled()" <% nvram_match_x( "",
																		"adbyby_rules_x", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
												...
												<table width="100%" align="center" cellpadding="3" cellspacing="0" class="table">
													...
													<tr id="row_rules_header" style="display:none">
														<td width="85%">
															<input type="text" maxlength="255" class="span12" size="200" name="adbybyrules_x_0"
															value="<% nvram_get_x(" ", "adbybyrules_x_0 "); %>" onKeyPress="return is_string(this,event);"
															/>
														</td>
														<td width="10%">
															<select name="adbybyrules_road_x_0" class="input" style="width: 65px">
																<option value="0" <% nvram_match_x( "", "adbybyrules_road_x_0", "0",
																"selected"); %>
																	>禁用
																</option>
																<option value="1" <% nvram_match_x( "", "adbybyrules_road_x_0", "1",
																"selected"); %>
																	>启用
																</option>
															</select>
														...
														<td width="5%">
															<center>
																...
																name="ManualRULESList2" value="<#CTL_add#>" size="12">
																	<i class="if if-btn-plus">
																	</i>
																</button>
															</center>
												...
												<table class="table">
													<tr>
														<td colspan="3">
															...
															<div id="script9">
																<textarea rows="8" wrap="off" spellcheck="false" maxlength="314571" class="span12"
																name="scripts.adbyby_adhost.sh" style="font-family:'Courier New'; font-size:12px;">
																	<% nvram_dump( "scripts.adbyby_adhost.sh", ""); %>
																</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3" style="border-top: 0 none;">
															...
															<div id="script10" style="display:none;">
																<textarea rows="24" wrap="off" spellcheck="false" maxlength="314571" class="span12"
																name="scripts.adbyby_adesc.sh" style="font-family:'Courier New'; font-size:12px;">
																	<% nvram_dump( "scripts.adbyby_adesc.sh", ""); %>
																</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3" style="border-top: 0 none;">
															...
															<div id="script11" style="display:none;">
																<textarea rows="24" wrap="off" spellcheck="false" maxlength="314571" class="span12"
																name="scripts.adbyby_blockip.sh" style="font-family:'Courier New'; font-size:12px;">
																	<% nvram_dump( "scripts.adbyby_blockip.sh", ""); %>
																</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3" style="border-top: 0 none;">
															...
															<div id="script12" style="display:none;">
																<textarea rows="24" wrap="off" spellcheck="false" maxlength="314571" class="span12"
																name="scripts.adbyby_adblack.sh" style="font-family:'Courier New'; font-size:12px;">
																	<% nvram_dump( "scripts.adbyby_adblack.sh", ""); %>
																</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3" style="border-top: 0 none;">
															...
															<div id="script13" style="display:none;">
																<textarea rows="8" wrap="off" spellcheck="false" maxlength="314571" class="span12"
																name="scripts.adbyby_rules.sh" style="font-family:'Courier New'; font-size:12px;">
																	<% nvram_dump( "scripts.adbyby_rules.sh", ""); %>
																</textarea>
															</div>
														</td>
													</tr>
