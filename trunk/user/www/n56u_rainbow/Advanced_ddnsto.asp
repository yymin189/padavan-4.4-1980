										...
										<div class="round_bottom">
											...
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<p>
														DDNSTO是简单、快速的内网穿透工具，不受网络限制，全局掌控私人设备
														<br>
													</p>
												</div>
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td>
															<input type="button" class="btn btn-success" value="ddnsto官网" onclick="window.open('https://www.ddnsto.com/')"
															size="0">
															<br>
															点击跳转到DDNSTO官网管理平台,获取ID
														</td>
													</tr>
													<tr>
														<th>
													...
													<tr>
														...
														<td style="border-top: 0 none;">
															<input type="checkbox" id="ddnsto_enable_fake" <% nvram_match_x( "",
															"ddnsto_enable" , "1" , "value=1 checked" ); %>
															<% nvram_match_x( "", "ddnsto_enable" , "0" , "value=0" ); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ddnsto_enable" id="ddnsto_enable_1"
																	class="input" value="1" <% nvram_match_x( "", "ddnsto_enable" , "1" ,
																	"checked" ); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ddnsto_enable" id="ddnsto_enable_0"
																		class="input" value="0" <% nvram_match_x( "", "ddnsto_enable" , "0" ,
																		"checked" ); %>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<tr>
														...
														<td>
															<input type="text" class="input" name="ddnsto_id" id="ddnsto_id" style="width: 200px"
															value="<% nvram_get_x(" ","ddnsto_id "); %>" />
														</td>
													</tr>
													<tr>
