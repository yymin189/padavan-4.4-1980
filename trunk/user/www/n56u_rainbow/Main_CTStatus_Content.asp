...
<html>
	<head>
		...
		<script>
			function initial() {
    show_banner(1);
    show_menu('if-m1-syssettings', 'if-m2-syslog', 5);
    show_footer();
}
		</script>
		<style>
											...
											<table width="100%" cellpadding="4" cellspacing="0" class="table">
												<tr>
													<td style="border-top: 0 none; padding-bottom: 0px;">
														<textarea rows="23" class="span12" style="height:403px; font-family:'Courier New', Courier, mono; font-size:13px;"
														readonly="readonly" wrap="off">
															<% nvram_dump( "conntrack.log", ""); %>
														</textarea>
													</td>
												</tr>
												<tr>
													<td style="text-align: right; padding-bottom: 0px;">
														...
														class="btn btn-primary" style="width: 219px;">
													</td>
												</tr>
											</table>
										</div>
