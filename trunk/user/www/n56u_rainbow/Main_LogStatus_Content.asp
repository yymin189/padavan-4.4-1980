...
function initial() {
    show_banner(2);
    show_menu('if-m1-syssettings', 'if-m2-syslog', 1);
    show_footer();
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<td style="border-top: 0 none; padding-bottom: 0px;">
															...
															<span class="alert alert-info" style="margin-left: 10px; padding-top: 4px; padding-bottom: 4px;"
															id="system_time">
															</span>
														</td>
													</tr>
													<tr>
														<td style="border-top: 0 none; padding-bottom: 0px;">
															<textarea rows="21" class="span12" style="height:377px; font-family:'Courier New', Courier, mono;"
													...
													<tr>
														<td style="text-align: left; padding-bottom: 0px;">
															...
															<input type="button" onClick="location.href='syslog.txt'" value="<#CTL_onlysave#>"
															class="btn btn-success btn-savelog">
															<input type="button" onClick="location.href=location.href" value="<#CTL_refresh#>"
															class="btn btn-primary btn-refreshlog">
														</td>
													</tr>
												</table>
											</div>
