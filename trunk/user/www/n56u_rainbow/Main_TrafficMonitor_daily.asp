...
<html>
	<head>
		...
		<script>
			var $j = jQuery.noConflict(); <% bandwidth("history", ""); %>
var scale = 2;
var dateFormat = 2;
var cprefix = "hist_";
var idTimerPoll = 0;
...
function switchPage(id) {
    ...
    return false;
		...
		<style>
			#tabs {margin-bottom: 0px;} .table-striped td {padding: 4px 8px;} .table
			td.dl, .table td.ul, .table td.total {text-align: right;}
		</style>
	</head>
	<body onload="initial();">
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="box well grad_colour_dark_blue">
									<h2 id="bx_label" class="box_head round_top">
										<#menu4#>
									</h2>
										...
										<div class="row-fluid">
											...
											<div style="margin-bottom: 0px; margin: -36px 0px 0px 0px;">
												<ul id="tabs" class="nav nav-tabs">
													...
													<li>
														<a href="#DY" id="tab_tr_dy">
															<#menu4_2_3#>
														</a>
													</li>
													<li>
														<a href="#MO" id="tab_tr_mo">
															<#menu4_2_4#>
														</a>
													</li>
												</ul>
