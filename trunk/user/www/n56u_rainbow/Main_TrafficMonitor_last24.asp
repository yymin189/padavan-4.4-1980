...
<html>
	<head>
		...
		<script type="text/javascript" src="/bootstrap/js/highcharts.js">
		</script>
		<script type="text/javascript" src="/bootstrap/js/highcharts_theme.js">
		</script>
		<script type="text/javascript" src="/net_speed_tabs.js">
		</script>
		...
		<script>
			var $j = jQuery.noConflict(); <% bandwidth("speed", ""); %>
var netChart;
var cprefix = "bw_24_";
...
function prepare_array_chart(id) {
    ...
    var data = [],
        p = 1 - parseInt(86400 / data_period);
    for (i = p; i <= 0; i++)
...
function switchPage(id) {
    ...
    return false;
		...
		<style>
			#tabs {margin-bottom: 0px;} .table-stat td {padding: 4px 8px;}
		</style>
	</head>
	<body onload="initial();">
										...
										<div class="row-fluid">
											...
											<div style="margin-bottom: 0px; margin: -36px 0px 0px 0px;">
												<ul id="tabs" class="nav nav-tabs">
													<li>
														<a href="javascript:void(0)" id="tab_bw_rt">
															<#menu4_2_1#>
														</a>
													</li>
													<li class="active">
														<a href="javascript:void(0)" id="tab_bw_24">
															<#menu4_2_2#>
														</a>
													</li>
													<li>
														<a href="javascript:void(0)" id="tab_tr_dy">
															<#menu4_2_3#>
														</a>
													</li>
													<li>
														<a href="javascript:void(0)" id="tab_tr_mo">
															<#menu4_2_4#>
														</a>
													</li>
												</ul>
												...
												<table style="width: 100%; margin-top: 6px; margin-bottom: 6px;">
													<tr>
														<td width="100%" align="center" style="text-align: center">
															<div id="net_chart" style="width: 850px; padding-left: 5px;">
															</div>
														</td>
													</tr>
												</table>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table table-stat">
												...
												<tr>
													...
													<td width="20%" align="center" valign="top" style="text-align:right;font-weight: bold;">
														<span id="rx-current">
														</span>
													</td>
													<td width="20%" align="center" valign="top" style="text-align:right" id="rx-avg">
													</td>
													<td width="20%" align="center" valign="top" style="text-align:right" id="rx-max">
													</td>
													<td width="20%" align="center" valign="top" style="text-align:right" id="rx-total">
													</td>
												</tr>
												<tr>
													<td width="9%" style="text-align:center; vertical-align: middle;">
													...
													<td width="20%" align="center" valign="top" style="text-align:right" id='tx-avg'>
													</td>
													<td width="20%" align="center" valign="top" style="text-align:right" id='tx-max'>
													</td>
													<td width="20%" align="center" valign="top" style="text-align:right" id='tx-total'>
													</td>
												</tr>
											</table>
										</div>
