	...
	<body onload="initial();" onunload="return unload_body();">
		...
		<div class="wrapper">
			...
			<form method="post" name="applyForm" id="applyForm" action="" target="hidden_frame">
				<input type="hidden" name="dummyShareway" id="dummyShareway" value="<% nvram_get_x("
				", "dummyShareway "); %>">
			...
			<form method="post" name="ddnsForm" id="ddnsForm" action="/start_apply.htm"
			target="hidden_frame">
			...
			<form method="post" name="parameterForm" id="parameterForm" action=""
			target="">
									...
									<div class="round_bottom">
										<div class="row-fluid">
											<div class="span8">
												...
												<iframe id="sub_frame" src="" width="100%" height="475" frameborder="0"
												scrolling="no">
												</iframe>
												<form name="hint_form">
												</form>
												...
												<div id="hintofPM" style="display:none;">
													<table width="99%" cellpadding="0" cellspacing="1">
														<thead>
															<tr>
																<td>
																	<h4 id="helpname" class="AiHintTitle">
																	</h4>
																</td>
															</tr>
														</thead>
														<tr>
															<td valign="top">
																<div class="alert alert-info" id="hint_body">
																</div>
																<iframe id="statusframe" name="statusframe" class="statusframe" src=""
																style="width: 97%; height: 300px;" frameborder="0">
																</iframe>
															</td>
														</tr>
													</table>
