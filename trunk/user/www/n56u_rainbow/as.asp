...
function show_sitemap() {
    ...
    for (var l = 0; l < l1; l++) {
		...
		<style>
			table#menu_body tr td.head {text-align: center;} table#menu_body tr td
			{vertical-align: top;}
		</style>
	</head>
											...
											<table class="table">
												<tr>
													...
													<td style="border-top: 0 none;">
														<table id="menu_body" width="100%" border="0" align="center" cellpadding="3"
														cellspacing="1" bgcolor="#CCCCCC" class="sitemap">
															<tr>
																<td width="25%">
																	&nbsp;
																</td>
