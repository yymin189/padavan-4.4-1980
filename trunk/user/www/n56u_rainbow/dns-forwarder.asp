...
<html>
	<head>
		...
		<script>
			var $j = jQuery.noConflict(); <% dnsforwarder_status(); %>
...
function initial() {
    show_banner(2);
    show_menu('if-m1-syssettings', 'if-m2-dnsforwarder', 1);
    show_footer();
											...
											<div class="row-fluid">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td id="dnsforwarder_status" colspan="3">
														</td>
													</tr>
													<tr>
														<th>
														...
														<td>
															<input type="checkbox" id="dns_forwarder_enable_fake" <% nvram_match_x(
															"", "dns_forwarder_enable", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "dns_forwarder_enable", "0", "value=0"); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="dns_forwarder_enable" id="dns_forwarder_enable_1"
																	<% nvram_match_x( "", "dns_forwarder_enable", "1", "checked"); %>
																	>
																<#checkbox_Yes#>
																		<input type="radio" value="0" name="dns_forwarder_enable" id="dns_forwarder_enable_0"
																		<% nvram_match_x( "", "dns_forwarder_enable", "0", "checked"); %>
																		>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="15" class="input" size="15" name="dns_forwarder_bind"
															style="width: 145px" value="<% nvram_get_x(" ","dns_forwarder_bind
													...
													<tr>
														...
														<td>
															<input type="text" maxlength="5" class="input" size="15" name="dns_forwarder_port"
															style="width: 145px" value="<% nvram_get_x(" ", "dns_forwarder_port
															"); %>">
														</td>
													</tr>
													<tr>
														...
														<td>
															<input type="text" maxlength="64" class="input" size="64" name="dns_forwarder_server"
															style="width: 145px" value="<% nvram_get_x(" ", "dns_forwarder_server
															"); %>">
														</td>
													</tr>
													<tr>
