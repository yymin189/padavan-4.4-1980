...
function create_server_cert() {
    ...
    $j.ajax({
        ...
        success: function(response) {
            var sys_result = (response != null && typeof response === 'object' && "sys_result" in response) ? response.sys_result : -1;
            clearTimeout(id_timeout_btn_gen);
            if (sys_result == 0) {
...
function showACLList(vnet_show, rnet_show, is_openvpn) {
    ...
    if (ACLList.length == 0)
        ...
        code += '<td style="padding-bottom: 0px;"><button class="btn btn-danger" type="submit" onclick="markGroupACL(this, 50, \' Del \');" name="VPNSACLList"><i class="if if-btn-minus"></i></button></td>';
        code += '</tr>'
    }
    code += '</table>';
...
function getHash() {
    ...
    return ('#' + arrHashes[0]);
		...
		<style>
			.caption-bold { font-weight: bold; } .table-list td { padding: 6px 8px;
			} .table-list input, .table-list select { margin-top: 0px; margin-bottom:
			0px; }
		</style>
	</head>
    ...
    location.href = "/as.asp";
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="vpns_num_x_0" value="<% nvram_get_x(" ", "vpns_num_x
				"); %>" readonly="1" />
								...
								<div class="round_bottom">
									<div>
										<ul class="nav nav-tabs" style="margin-bottom: 10px;">
											<li class="active">
												<a id="tab_vpns_cfg" href="#cfg">
													<#Settings#>
												</a>
											</li>
											<li>
												<a id="tab_vpns_ssl" style="display:none" href="#ssl">
													<#OVPN_Cert#>
												</a>
											</li>
											<li>
												<a id="tab_vpns_acl" style="display:none" href="#acl">
													<#VPNS_Accnt#>
												</a>
											</li>
											<li>
												<a id="tab_vpns_cli" style="display:none" href="#cli">
													<#ConClients#>
												</a>
											</li>
										</ul>
									...
									<div id="wnd_vpns_cfg">
										...
										<table class="table">
											<tr>
												...
												<td style="padding-bottom: 0px; border-top: 0 none;">
													<input type="checkbox" id="vpns_enable_fake" <% nvram_match_x( "",
													"vpns_enable", "1", "value=1 checked"); %>
													<% nvram_match_x( "", "vpns_enable", "0", "value=0"); %>
														>
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" name="vpns_enable" id="vpns_enable_1" class="input"
															value="1" onclick="change_vpns_enabled();" <% nvram_match_x( "",
															"vpns_enable", "1", "checked"); %>
															>
															<#checkbox_Yes#>
																<input type="radio" name="vpns_enable" id="vpns_enable_0" class="input"
																value="0" onclick="change_vpns_enabled();" <% nvram_match_x( "",
																"vpns_enable", "0", "checked"); %>
																>
																<#checkbox_No#>
														</div>
												</td>
										...
										<table class="table" id="tbl_vpn_config" style="display:none">
											...
											<tr>
												...
												<td>
													<select name="vpns_type" class="input" onchange="change_vpns_type();">
														<option value="0" <% nvram_match_x( "", "vpns_type", "0", "selected");
														%>
															>PPTP
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_type", "1", "selected");
														%>
															>L2TP (w/o IPSec)
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_type", "2", "selected");
														%>
															>OpenVPN
														</option>
													</select>
													<span id="certs_hint" style="display:none" class="label label-warning">
														<#OVPN_Hint#>
													</span>
												</td>
											</tr>
											<tr id="row_vpns_auth">
												...
												<td>
													<select name="vpns_auth" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_auth", "0", "selected");
														%>
															>MS-CHAPv2 (*)
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_auth", "1", "selected");
														%>
															>MS-CHAPv2 & CHAP
														</option>
													</select>
											...
											<tr id="row_vpns_mppe">
												...
												<td>
													<select name="vpns_mppe" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_mppe", "0", "selected");
														%>
															>Auto
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_mppe", "1", "selected");
														%>
															>MPPE-128 (*)
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_mppe", "2", "selected");
														%>
															>MPPE-40
														</option>
														<option value="3" <% nvram_match_x( "", "vpns_mppe", "3", "selected");
														%>
															>No encryption
														</option>
													</select>
											...
											<tr id="row_vpns_mtu">
												...
												<td>
													<input type="text" maxlength="4" size="5" name="vpns_mtu" class="input"
													value="<% nvram_get_x(" ", "vpns_mtu "); %>" onkeypress="return is_number(this,event);"
													/>
													&nbsp;
											...
											<tr id="row_vpns_mru">
												...
												<td>
													<input type="text" maxlength="4" size="5" name="vpns_mru" class="input"
													value="<% nvram_get_x(" ", "vpns_mru "); %>" onkeypress="return is_number(this,event);"
													/>
													&nbsp;
													<span style="color:#888;">
														[1000..1460]
											...
											<tr id="row_vpns_ov_mode" style="display:none">
												...
												<td>
													<select name="vpns_ov_mode" class="input" onchange="change_vpns_vnet_enable();">
														<option value="0" <% nvram_match_x( "", "vpns_ov_mode", "0",
														"selected"); %>
															>L2 - TAP (Ethernet)
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_mode", "1",
														"selected"); %>
															>L3 - TUN (IP)
														</option>
													</select>
											...
											<tr id="row_vpns_ov_prot" style="display:none">
												...
												<td>
													<select name="vpns_ov_prot" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_ov_prot", "0",
														"selected"); %>
															>UDP over IPv4 (*)
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_prot", "1",
														"selected"); %>
															>TCP over IPv4
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_ov_prot", "2",
														"selected"); %>
															>UDP over IPv6
														</option>
														<option value="3" <% nvram_match_x( "", "vpns_ov_prot", "3",
														"selected"); %>
															>TCP over IPv6
														</option>
														<option value="4" <% nvram_match_x( "", "vpns_ov_prot", "4",
														"selected"); %>
															>UDP both
														</option>
														<option value="5" <% nvram_match_x( "", "vpns_ov_prot", "5",
														"selected"); %>
															>TCP both
														</option>
													</select>
											...
											<tr id="row_vpns_ov_port" style="display:none">
												...
												<td>
													<input type="text" maxlength="5" size="5" name="vpns_ov_port" class="input"
													value="<% nvram_get_x(" ", "vpns_ov_port "); %>" onkeypress="return is_number(this,event);"
													/>
													&nbsp;
													<span style="color:#888;">
														[ 1194 ]
											...
											<tr id="row_vpns_ov_mdig" style="display:none">
												...
												<td>
													<select name="vpns_ov_mdig" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_ov_mdig", "0",
														"selected"); %>
															>[MD5] MD-5, 128 bit
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_mdig", "1",
														"selected"); %>
															>[SHA1] SHA-1, 160 bit (*)
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_ov_mdig", "2",
														"selected"); %>
															>[SHA224] SHA-224, 224 bit
														</option>
														<option value="3" <% nvram_match_x( "", "vpns_ov_mdig", "3",
														"selected"); %>
															>[SHA256] SHA-256, 256 bit
														</option>
														<option value="4" <% nvram_match_x( "", "vpns_ov_mdig", "4",
														"selected"); %>
															>[SHA384] SHA-384, 384 bit
														</option>
														<option value="5" <% nvram_match_x( "", "vpns_ov_mdig", "5",
														"selected"); %>
											...
											<tr id="row_vpns_ov_ciph" style="display:none">
												...
												<td>
													<select name="vpns_ov_ciph" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_ov_ciph", "0",
														"selected"); %>
															>[none]
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_ciph", "1",
														"selected"); %>
															>[DES-CBC] DES, 64 bit
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_ov_ciph", "2",
														"selected"); %>
															>[DES-EDE-CBC] 3DES, 128 bit
														</option>
														<option value="3" <% nvram_match_x( "", "vpns_ov_ciph", "3",
														"selected"); %>
															>[BF-CBC] Blowfish, 128 bit (*)
														</option>
														<option value="4" <% nvram_match_x( "", "vpns_ov_ciph", "4",
														"selected"); %>
															>[AES-128-CBC] AES, 128 bit
														</option>
														<option value="5" <% nvram_match_x( "", "vpns_ov_ciph", "5",
														"selected"); %>
															>[AES-192-CBC] AES, 192 bit
														</option>
														<option value="6" <% nvram_match_x( "", "vpns_ov_ciph", "6",
														"selected"); %>
															>[DES-EDE3-CBC] 3DES, 192 bit
														</option>
														<option value="7" <% nvram_match_x( "", "vpns_ov_ciph", "7",
														"selected"); %>
															>[DESX-CBC] DES-X, 192 bit
														</option>
														<option value="8" <% nvram_match_x( "", "vpns_ov_ciph", "8",
														"selected"); %>
															>[AES-256-CBC] AES, 256 bit
														</option>
														<option value="9" <% nvram_match_x( "", "vpns_ov_ciph", "9",
														"selected"); %>
															>[CAMELLIA-128-CBC] CAM, 128 bit
														</option>
														<option value="10" <% nvram_match_x( "", "vpns_ov_ciph", "10",
														"selected"); %>
															>[CAMELLIA-192-CBC] CAM, 192 bit
														</option>
														<option value="11" <% nvram_match_x( "", "vpns_ov_ciph", "11",
														"selected"); %>
															>[CAMELLIA-256-CBC] CAM, 256 bit
														</option>
														<option value="12" <% nvram_match_x( "", "vpns_ov_ciph", "12",
														"selected"); %>
															>[AES-128-GCM] AES-GCM, 128 bit
														</option>
														<option value="13" <% nvram_match_x( "", "vpns_ov_ciph", "13",
														"selected"); %>
															>[AES-192-GCM] AES-GCM, 192 bit
														</option>
														<option value="14" <% nvram_match_x( "", "vpns_ov_ciph", "14",
														"selected"); %>
															>[AES-256-GCM] AES-GCM, 256 bit
														</option>
														<option value="15" <% nvram_match_x( "", "vpns_ov_ciph", "15",
														"selected"); %>
											...
											<tr id="row_vpns_ov_ncp_clist" style="display:none">
												...
												<td>
													<input type="text" maxlength="256" size="15" name="vpns_ov_ncp_clist"
													class="input" style="width: 286px;" value="<% nvram_get_x(" ", "vpns_ov_ncp_clist
											...
											<tr id="row_vpns_ov_compress" style="display:none">
												...
												<td>
													<select name="vpns_ov_compress" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_ov_compress", "0",
														"selected"); %>
															>
															<#btn_Disable#>
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_compress", "1",
														"selected"); %>
															>
															<#checkbox_No#>
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_ov_compress", "2",
														"selected"); %>
															>
															<#OVPN_COMPRESS_Item2#>
																(*)
														</option>
														<option value="3" <% nvram_match_x( "", "vpns_ov_compress", "3",
														"selected"); %>
															>
															<#OVPN_COMPRESS_Item3#>
														</option>
														<option value="4" <% nvram_match_x( "", "vpns_ov_compress", "4",
														"selected"); %>
															>
															<#OVPN_COMPRESS_Item4#>
														</option>
											...
											<tr id="row_vpns_ov_atls" style="display:none" onchange="change_vpns_ov_atls();">
												...
												<td>
													<select name="vpns_ov_atls" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_ov_atls", "0",
														"selected"); %>
															>
															<#checkbox_No#>
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_atls", "1",
														"selected"); %>
															>
															<#OVPN_HMAC_Item1#>
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_ov_atls", "2",
														"selected"); %>
															>
															<#OVPN_HMAC_Item2#>
														</option>
											...
											<tr id="row_vpns_ov_tcv2" style="display:none" onchange="change_vpns_ov_tcv2();">
												...
												<td>
													<select name="vpns_ov_tcv2" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_ov_tcv2", "0",
														"selected"); %>
															>
															<#checkbox_No#>
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_tcv2", "1",
														"selected"); %>
															>
															<#OVPN_USE_TCV2_ItemS#>
														</option>
											...
											<tr id="row_vpns_ov_conf" style="display:none">
												<td colspan="2" style="padding-bottom: 15px;">
													<a href="javascript:spoiler_toggle('spoiler_vpns_ov_conf')">
														<span>
															<#OVPN_User#>
														</span>
													</a>
													<div id="spoiler_vpns_ov_conf" style="display:none;">
														<textarea rows="16" wrap="off" spellcheck="false" maxlength="8192" class="span12"
														name="ovpnsvr.server.conf" style="font-family:'Courier New'; font-size:12px;">
															<% nvram_dump( "ovpnsvr.server.conf", ""); %>
														</textarea>
													</div>
												</td>
											</tr>
											<tr id="row_vpns_script">
												<td colspan="2" style="padding-bottom: 15px;">
													<a href="javascript:spoiler_toggle('spoiler_script')">
														<span>
															<#RunPostVPNS#>
														</span>
													</a>
													<div id="spoiler_script" style="display:none;">
														<textarea rows="16" wrap="off" spellcheck="false" maxlength="8192" class="span12"
														name="scripts.vpns_client_script.sh" style="font-family:'Courier New'; font-size:12px;">
															<% nvram_dump( "scripts.vpns_client_script.sh", ""); %>
														</textarea>
													</div>
												</td>
											</tr>
											...
											<tr id="row_vpns_vnet" style="display:none">
												...
												<td>
													<input type="text" maxlength="15" class="input" size="15" name="vpns_vnet"
													value="<% nvram_get_x(" ", "vpns_vnet "); %>" onKeyPress="return is_ipaddr(this,event);">
													&nbsp;
													<span style="color:#888;">
														[ 10.8.0.0 ]
													</span>
											...
											<tr id="row_vpns_cast">
												...
												<td align="left">
													<select name="vpns_cast" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_cast", "0", "selected");
														%>
															>
															<#checkbox_No#>
																(*)
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_cast", "1", "selected");
														%>
															>LAN to VPN
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_cast", "2", "selected");
														%>
															>VPN to LAN
														</option>
														<option value="3" <% nvram_match_x( "", "vpns_cast", "3", "selected");
														%>
															>Both directions
														</option>
													</select>
											...
											<tr id="row_vpns_ov_rdgw" style="display:none">
												...
												<td>
													<select name="vpns_ov_rdgw" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_ov_rdgw", "0",
														"selected"); %>
															>
															<#checkbox_No#>
																(*)
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_ov_rdgw", "1",
														"selected"); %>
															>
															<#checkbox_Yes#>
														</option>
											...
											<tr id="row_vpns_actl">
												...
												<td style="padding-bottom: 0px;">
													<select name="vpns_actl" class="input">
														<option value="0" <% nvram_match_x( "", "vpns_actl", "0", "selected");
														%>
															>
															<#VPNS_ACtl_Item0#>
														</option>
														<option value="1" <% nvram_match_x( "", "vpns_actl", "1", "selected");
														%>
															>
															<#VPNS_ACtl_Item1#>
														</option>
														<option value="2" <% nvram_match_x( "", "vpns_actl", "2", "selected");
														%>
															>
															<#VPNS_ACtl_Item2#>
														</option>
														<option value="3" <% nvram_match_x( "", "vpns_actl", "3", "selected");
														%>
															>
															<#VPNS_ACtl_Item3#>
														</option>
														<option value="4" <% nvram_match_x( "", "vpns_actl", "4", "selected");
														%>
															>
															<#VPNS_ACtl_Item4#>
														</option>
										...
										<table class="table" id="tbl_vpn_pool" style="display:none">
											...
											<tr id="row_lan_dhcp">
												...
												<td>
													<span>
														<% nvram_get_x( "", "dhcp_start"); %>
													</span>
													<span>
														&nbsp;~&nbsp;
													</span>
													<span>
														<% nvram_get_x( "", "dhcp_end"); %>
													</span>
												</td>
											</tr>
											<tr id="row_pool_edit">
												...
												<td>
													...
													<input type="text" maxlength="3" size="2" name="vpns_cli0" value="<% nvram_get_x("
													", "vpns_cli0 "); %>" style="width: 25px;" onKeyPress="return is_number(this,event);"
													/>
													<span>
														&nbsp;~&nbsp;
													</span>
													...
													<input type="text" maxlength="3" size="2" name="vpns_cli1" value="<% nvram_get_x("
													", "vpns_cli1 "); %>" style="width: 25px;" onKeyPress="return is_number(this,event);"
													/>
												</td>
											</tr>
											<tr id="row_pool_view">
										...
										<table class="table" style="margin-bottom: 0px;" id="tbl_vpns_gen" style="display:none">
											<tr>
												<td align="right" style="border-top: 0 none; padding-top: 0px; text-align:right;">
													...
													<input id="vpns_gen_cn" type="text" maxlength="32" size="10" style="width: 105px;"
													placeholder="OpenVPN Server" onKeyPress="return is_string(this,event);"
													/>
												</td>
												<td align="left" style="border-top: 0 none; padding-top: 0px;">
													...
													<select id="vpns_gen_rb" class="input" style="width: 108px;">
														...
														<option value="prime256v1">
															EC P-256
														</option>
														<option value="secp384r1">
															EC P-384
														</option>
														<option value="secp521r1">
															EC P-521
														</option>
												...
												<td align="left" style="border-top: 0 none; padding-top: 0px;">
													...
													<input id="vpns_gen_dv" type="text" maxlength="5" size="10" style="width: 35px;"
													value="365" onKeyPress="return is_number(this,event);" />
												</td>
												<td align="left" style="border-top: 0 none; padding-top: 0px;">
													<input id="vpns_gen_bn" type="button" class="btn" style="width: 145px; outline:0"
													onclick="create_server_cert();" value="<#VPNS_GenNew#>" />
												</td>
											</tr>
											<tr id="row_vpns_exp" style="display:none">
												<td align="right" style="text-align:right;">
													...
													<input id="vpns_exp_cn" type="text" maxlength="32" size="10" style="width: 105px;"
													placeholder="client@ovpn" onKeyPress="return is_string(this,event);" />
												</td>
												<td align="left">
													<span class="caption-bold">
														Bits:
												...
												<td align="left">
													...
													<input id="vpns_exp_dv" type="text" maxlength="5" size="10" style="width: 35px;"
													value="365" onKeyPress="return is_number(this,event);" />
												</td>
												<td align="left">
													<input id="vpns_exp_bn" type="button" class="btn" style="width: 145px; outline:0"
													onclick="export_client_ovpn('');" value="<#VPNS_Export#>" />
												</td>
											</tr>
											<tr>
										...
										<table class="table">
											<tr>
												<td style="padding-bottom: 0px; border-top: 0 none;">
													...
													<textarea rows="4" wrap="off" spellcheck="false" maxlength="8192" class="span12"
													name="ovpnsvr.ca.crt" style="font-family:'Courier New'; font-size:12px;">
														<% nvram_dump( "ovpnsvr.ca.crt", ""); %>
													</textarea>
												</td>
											</tr>
											<tr>
												<td style="padding-bottom: 0px; border-top: 0 none;">
													<span class="caption-bold">
														Diffie-Hellman PEM (dh1024.pem):
													</span>
													<textarea rows="4" wrap="off" spellcheck="false" maxlength="4096" class="span12"
													name="ovpnsvr.dh1024.pem" style="font-family:'Courier New'; font-size:12px;">
														<% nvram_dump( "ovpnsvr.dh1024.pem", ""); %>
													</textarea>
												</td>
											</tr>
											<tr>
												<td style="padding-bottom: 0px; border-top: 0 none;">
													...
													<textarea rows="4" wrap="off" spellcheck="false" maxlength="8192" class="span12"
													name="ovpnsvr.server.crt" style="font-family:'Courier New'; font-size:12px;">
														<% nvram_dump( "ovpnsvr.server.crt", ""); %>
													</textarea>
												</td>
											</tr>
											<tr>
												<td style="padding-bottom: 0px; border-top: 0 none;">
													<span class="caption-bold">
														Server Private Key (server.key) - secret:
													</span>
													<textarea rows="4" wrap="off" spellcheck="false" maxlength="8192" class="span12"
													name="ovpnsvr.server.key" style="font-family:'Courier New'; font-size:12px;">
														<% nvram_dump( "ovpnsvr.server.key", ""); %>
													</textarea>
												</td>
											</tr>
											<tr id="row_ta_key">
												<td style="padding-bottom: 0px; border-top: 0 none;">
													<span class="caption-bold">
														TLS Auth/Crypt Key (ta.key/tc.key) - secret:
													</span>
													<textarea rows="4" wrap="off" spellcheck="false" maxlength="8192" class="span12"
													name="ovpnsvr.ta.key" style="font-family:'Courier New'; font-size:12px;">
														<% nvram_dump( "ovpnsvr.ta.key", ""); %>
													</textarea>
												</td>
											</tr>
											<tr id="row_stc2_key">
												<td style="padding-bottom: 0px; border-top: 0 none;">
													<span class="caption-bold">
														TLS Crypt v2 Key (stc2.key) - secret:
													</span>
													<textarea rows="4" wrap="off" spellcheck="false" maxlength="8192" class="span12"
													name="ovpnsvr.stc2.key" style="font-family:'Courier New'; font-size:12px;">
														<% nvram_dump( "ovpnsvr.stc2.key", ""); %>
													</textarea>
												</td>
											</tr>
										</table>
										<table class="table">
											<tr>
												<td style="border: 0 none;">
													<center>
														<input name="button2" type="button" class="btn btn-primary" style="width: 219px"
														onclick="applyRule();" value="<#CTL_apply#>" />
													</center>
												</td>
											</tr>
									...
									<div id="wnd_vpns_acl" style="display:none">
										<div id="div_acl_info" class="alert alert-info" style="margin: 10px;">
										</div>
										<table class="table">
											<tr>
												<th width="20%" style="border-top: 0 none;">
													<#VPNS_CName#>
														:
												</th>
												<th width="20%" style="border-top: 0 none;" id="col_pass">
													<#ISP_Authentication_pass#>
												</th>
												<th width="20%" style="border-top: 0 none;">
													<#VPNS_FixIP#>
												</th>
												<th width="35%" style="border-top: 0 none;">
													<#VPNS_RNet#>
												</th>
												<th width="5%" style="border-top: 0 none;">
													&nbsp;
												</th>
											</tr>
											<tr>
												<td>
													<input type="text" size="14" class="span12" autocomplete="off" maxlength="32"
													name="vpns_user_x_0" value="<% nvram_get_x(" ", "vpns_user_x_0 "); %>"
													onkeypress="return is_string(this,event);" />
												</td>
												<td>
													<input type="text" size="14" class="span12" autocomplete="off" maxlength="32"
													name="vpns_pass_x_0" onkeypress="return is_string(this,event);" />
												</td>
												<td>
													<span id="vpnip3">
													</span>
													<input type="text" size="2" maxlength="3" style="width: 25px;" name="vpns_addr_x_0"
													value="<% nvram_get_x(" ", "vpns_addr_x_0 "); %>" onkeypress="return is_number(this,event);"
													/>
												</td>
												<td>
													<input type="text" size="14" maxlength="15" style="width: 90px;" name="vpns_rnet_x_0"
													value="<% nvram_get_x(" ", "vpns_rnet_x_0 "); %>" onkeypress="return is_ipaddr(this,event);"
													/>
													&nbsp;/
													<input type="text" size="14" maxlength="15" style="width: 90px;" name="vpns_rmsk_x_0"
													value="<% nvram_get_x(" ", "vpns_rmsk_x_0 "); %>" onkeypress="return is_ipaddr(this,event);"
													/>
												</td>
												<td>
													<button class="btn" type="submit" onclick="return markGroupACL(this, 50, ' Add ');"
													name="VPNSACLList2">
										...
										<table class="table">
											<tr>
												<td style="border: 0 none;">
													<center>
														<input name="button3" type="button" class="btn btn-primary" style="width: 219px"
														onclick="applyRule();" value="<#CTL_apply#>" />
													</center>
												</td>
											</tr>
									...
									<div id="wnd_vpns_cli" style="display:none">
										<table class="table" style="width: 100%">
											<tr>
												...
												<th width="25%" style="border-top: 0 none;">
													<#VPNS_CName#>
												</th>
												<th width="20%" style="border-top: 0 none;">
